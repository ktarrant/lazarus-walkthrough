...
Type to filter and reveal a matching Pokémon card.

<input id="lookup-input" type="text" placeholder="Start typing a name..." />
...
<div class="lookup-card" data-name="alolan raichu alolan-raichu">
{{#include ./pokemon/alolan-raichu.md}}
</div>
...
<div class="lookup-card" data-name="altaria altaria">
{{#include ./pokemon/altaria.md}}
</div>
...
<div class="lookup-card" data-name="anorith anorith">
{{#include ./pokemon/anorith.md}}
</div>
<div class="lookup-card" data-name="appletun appletun">
{{#include ./pokemon/appletun.md}}
</div>
<div class="lookup-card" data-name="applin applin">
{{#include ./pokemon/applin.md}}
</div>
...
<div class="lookup-card" data-name="banette banette">
{{#include ./pokemon/banette.md}}
</div>
...
<div class="lookup-card" data-name="bellsprout bellsprout">
{{#include ./pokemon/bellsprout.md}}
</div>
<div class="lookup-card" data-name="bewear bewear">
{{#include ./pokemon/bewear.md}}
</div>
<div class="lookup-card" data-name="blitzle blitzle">
{{#include ./pokemon/blitzle.md}}
</div>
<div class="lookup-card" data-name="boltund boltund">
{{#include ./pokemon/boltund.md}}
</div>
...
<div class="lookup-card" data-name="bruxish bruxish">
{{#include ./pokemon/bruxish.md}}
</div>
...
<div class="lookup-card" data-name="charjabug charjabug">
{{#include ./pokemon/charjabug.md}}
</div>
<div class="lookup-card" data-name="chatot chatot">
{{#include ./pokemon/chatot.md}}
</div>
...
<div class="lookup-card" data-name="chikorita chikorita">
{{#include ./pokemon/chikorita.md}}
</div>
<div class="lookup-card" data-name="chinchou chinchou">
{{#include ./pokemon/chinchou.md}}
</div>
<div class="lookup-card" data-name="clamperl clamperl">
{{#include ./pokemon/clamperl.md}}
</div>
<div class="lookup-card" data-name="clauncher clauncher">
{{#include ./pokemon/clauncher.md}}
</div>
<div class="lookup-card" data-name="clawitzer clawitzer">
{{#include ./pokemon/clawitzer.md}}
</div>
<div class="lookup-card" data-name="claydol claydol">
{{#include ./pokemon/claydol.md}}
</div>
<div class="lookup-card" data-name="clodsire clodsire">
{{#include ./pokemon/clodsire.md}}
</div>
<div class="lookup-card" data-name="cloyster cloyster">
{{#include ./pokemon/cloyster.md}}
</div>
...
<div class="lookup-card" data-name="cubone cubone">
{{#include ./pokemon/cubone.md}}
</div>
...
<div class="lookup-card" data-name="cyclizar cyclizar">
{{#include ./pokemon/cyclizar.md}}
</div>
...
<div class="lookup-card" data-name="dipplin dipplin">
{{#include ./pokemon/dipplin.md}}
</div>
<div class="lookup-card" data-name="dodrio dodrio">
{{#include ./pokemon/dodrio.md}}
</div>
...
<div class="lookup-card" data-name="drapion drapion">
{{#include ./pokemon/drapion.md}}
</div>
<div class="lookup-card" data-name="dratini dratini">
{{#include ./pokemon/dratini.md}}
</div>
<div class="lookup-card" data-name="dreepy dreepy">
{{#include ./pokemon/dreepy.md}}
</div>
<div class="lookup-card" data-name="drowzee drowzee">
{{#include ./pokemon/drowzee.md}}
</div>
<div class="lookup-card" data-name="ducklett ducklett">
{{#include ./pokemon/ducklett.md}}
</div>
<div class="lookup-card" data-name="duosion duosion">
{{#include ./pokemon/duosion.md}}
</div>
...
<div class="lookup-card" data-name="dustox dustox">
{{#include ./pokemon/dustox.md}}
</div>
<div class="lookup-card" data-name="dwebble dwebble">
{{#include ./pokemon/dwebble.md}}
</div>
<div class="lookup-card" data-name="eevee eevee">
...
<div class="lookup-card" data-name="farigiraf farigiraf">
{{#include ./pokemon/farigiraf.md}}
</div>
...
<div class="lookup-card" data-name="finneon finneon">
{{#include ./pokemon/finneon.md}}
</div>
...
<div class="lookup-card" data-name="floatzel floatzel">
{{#include ./pokemon/floatzel.md}}
</div>
...
<div class="lookup-card" data-name="galarian corsola galarian-corsola">
{{#include ./pokemon/galarian-corsola.md}}
</div>
<div class="lookup-card" data-name="galarian linoone galarian-linoone">
{{#include ./pokemon/galarian-linoone.md}}
</div>
<div class="lookup-card" data-name="galarian meowth galarian-meowth">
{{#include ./pokemon/galarian-meowth.md}}
</div>
<div class="lookup-card" data-name="galarian ponyta galarian-ponyta">
{{#include ./pokemon/galarian-ponyta.md}}
</div>
<div class="lookup-card" data-name="galarian rapidash galarian-rapidash">
{{#include ./pokemon/galarian-rapidash.md}}
</div>
...
<div class="lookup-card" data-name="gorebyss gorebyss">
{{#include ./pokemon/gorebyss.md}}
</div>
<div class="lookup-card" data-name="gothita gothita">
{{#include ./pokemon/gothita.md}}
</div>
<div class="lookup-card" data-name="gothitelle gothitelle">
{{#include ./pokemon/gothitelle.md}}
</div>
...
<div class="lookup-card" data-name="grubbin grubbin">
{{#include ./pokemon/grubbin.md}}
</div>
<div class="lookup-card" data-name="gurdurr gurdurr">
{{#include ./pokemon/gurdurr.md}}
</div>
...
<div class="lookup-card" data-name="hoothoot hoothoot">
{{#include ./pokemon/hoothoot.md}}
</div>
<div class="lookup-card" data-name="hoppip hoppip">
{{#include ./pokemon/hoppip.md}}
</div>
<div class="lookup-card" data-name="houndoom houndoom">
{{#include ./pokemon/houndoom.md}}
</div>
<div class="lookup-card" data-name="houndour houndour">
{{#include ./pokemon/houndour.md}}
</div>
...
<div class="lookup-card" data-name="kilowattrel kilowattrel">
{{#include ./pokemon/kilowattrel.md}}
</div>
<div class="lookup-card" data-name="kirlia kirlia">
{{#include ./pokemon/kirlia.md}}
</div>
...
<div class="lookup-card" data-name="lanturn lanturn">
{{#include ./pokemon/lanturn.md}}
</div>
<div class="lookup-card" data-name="lapras lapras">
{{#include ./pokemon/lapras.md}}
</div>
...
<div class="lookup-card" data-name="lillipup lillipup">
{{#include ./pokemon/lillipup.md}}
</div>
<div class="lookup-card" data-name="linoone linoone">
{{#include ./pokemon/linoone.md}}
</div>
<div class="lookup-card" data-name="litleo litleo">
{{#include ./pokemon/litleo.md}}
</div>
<div class="lookup-card" data-name="litten litten">
{{#include ./pokemon/litten.md}}
</div>
<div class="lookup-card" data-name="litwick litwick">
{{#include ./pokemon/litwick.md}}
</div>
<div class="lookup-card" data-name="lumineon lumineon">
{{#include ./pokemon/lumineon.md}}
</div>
...
<div class="lookup-card" data-name="munna munna">
{{#include ./pokemon/munna.md}}
</div>
<div class="lookup-card" data-name="murkrow murkrow">
{{#include ./pokemon/murkrow.md}}
</div>
<div class="lookup-card" data-name="musharna musharna">
{{#include ./pokemon/musharna.md}}
</div>
<div class="lookup-card" data-name="natu natu">
{{#include ./pokemon/natu.md}}
</div>
...
<div class="lookup-card" data-name="noctowl noctowl">
{{#include ./pokemon/noctowl.md}}
</div>
<div class="lookup-card" data-name="nosepass nosepass">
{{#include ./pokemon/nosepass.md}}
</div>
<div class="lookup-card" data-name="numel numel">
{{#include ./pokemon/numel.md}}
</div>
<div class="lookup-card" data-name="obstagoon obstagoon">
{{#include ./pokemon/obstagoon.md}}
</div>
...
<div class="lookup-card" data-name="oranguru oranguru">
{{#include ./pokemon/oranguru.md}}
</div>
<div class="lookup-card" data-name="oricorio baile oricorio-baile">
{{#include ./pokemon/oricorio-baile.md}}
</div>
<div class="lookup-card" data-name="oricorio pa'u oricorio-pau">
{{#include ./pokemon/oricorio-pau.md}}
</div>
<div class="lookup-card" data-name="oricorio pom-pom oricorio-pom-pom">
{{#include ./pokemon/oricorio-pom-pom.md}}
</div>
...
<div class="lookup-card" data-name="pansage pansage">
{{#include ./pokemon/pansage.md}}
</div>
<div class="lookup-card" data-name="pansear pansear">
{{#include ./pokemon/pansear.md}}
</div>
...
<div class="lookup-card" data-name="pawmi pawmi">
{{#include ./pokemon/pawmi.md}}
</div>
...
<div class="lookup-card" data-name="perrserker perrserker">
{{#include ./pokemon/perrserker.md}}
</div>
<div class="lookup-card" data-name="persian persian">
{{#include ./pokemon/persian.md}}
</div>
<div class="lookup-card" data-name="phanpy phanpy">
{{#include ./pokemon/phanpy.md}}
</div>
<div class="lookup-card" data-name="pichu pichu">
{{#include ./pokemon/pichu.md}}
</div>
<div class="lookup-card" data-name="pikachu pikachu">
{{#include ./pokemon/pikachu.md}}
</div>
...
<div class="lookup-card" data-name="pyroar♂ pyroar-m">
{{#include ./pokemon/pyroar-m.md}}
</div>
...
<div class="lookup-card" data-name="remoraid remoraid">
{{#include ./pokemon/remoraid.md}}
</div>
<div class="lookup-card" data-name="reuniclus reuniclus">
{{#include ./pokemon/reuniclus.md}}
</div>
<div class="lookup-card" data-name="ribombee ribombee">
{{#include ./pokemon/ribombee.md}}
</div>
<div class="lookup-card" data-name="rockruff rockruff">
{{#include ./pokemon/rockruff.md}}
</div>
<div class="lookup-card" data-name="rowlet rowlet">
{{#include ./pokemon/rowlet.md}}
</div>
<div class="lookup-card" data-name="rufflet rufflet">
{{#include ./pokemon/rufflet.md}}
</div>
...
<div class="lookup-card" data-name="scraggy scraggy">
{{#include ./pokemon/scraggy.md}}
</div>
<div class="lookup-card" data-name="scyther scyther">
{{#include ./pokemon/scyther.md}}
</div>
<div class="lookup-card" data-name="sealeo sealeo">
{{#include ./pokemon/sealeo.md}}
</div>
<div class="lookup-card" data-name="seel seel">
{{#include ./pokemon/seel.md}}
</div>
<div class="lookup-card" data-name="shedinja shedinja">
{{#include ./pokemon/shedinja.md}}
</div>
...
<div class="lookup-card" data-name="shroomish shroomish">
{{#include ./pokemon/shroomish.md}}
</div>
<div class="lookup-card" data-name="shuppet shuppet">
{{#include ./pokemon/shuppet.md}}
</div>
...
<div class="lookup-card" data-name="skiploom skiploom">
{{#include ./pokemon/skiploom.md}}
</div>
<div class="lookup-card" data-name="skorupi skorupi">
{{#include ./pokemon/skorupi.md}}
</div>
<div class="lookup-card" data-name="skrelp skrelp">
{{#include ./pokemon/skrelp.md}}
</div>
...
<div class="lookup-card" data-name="snorunt snorunt">
{{#include ./pokemon/snorunt.md}}
</div>
<div class="lookup-card" data-name="snover snover">
{{#include ./pokemon/snover.md}}
</div>
<div class="lookup-card" data-name="solosis solosis">
{{#include ./pokemon/solosis.md}}
</div>
...
<div class="lookup-card" data-name="swanna swanna">
{{#include ./pokemon/swanna.md}}
</div>
...
<div class="lookup-card" data-name="tentacruel tentacruel">
{{#include ./pokemon/tentacruel.md}}
</div>
<div class="lookup-card" data-name="timburr timburr">
{{#include ./pokemon/timburr.md}}
</div>
...
<div class="lookup-card" data-name="tirtouga tirtouga">
{{#include ./pokemon/tirtouga.md}}
</div>
<div class="lookup-card" data-name="toedscool toedscool">
{{#include ./pokemon/toedscool.md}}
</div>
<div class="lookup-card" data-name="toedscruel toedscruel">
{{#include ./pokemon/toedscruel.md}}
</div>
...
<div class="lookup-card" data-name="togetic togetic">
{{#include ./pokemon/togetic.md}}
</div>
...
<div class="lookup-card" data-name="toucannon toucannon">
{{#include ./pokemon/toucannon.md}}
</div>
<div class="lookup-card" data-name="trapinch trapinch">
{{#include ./pokemon/trapinch.md}}
</div>
<div class="lookup-card" data-name="tropius tropius">
{{#include ./pokemon/tropius.md}}
</div>
...
<div class="lookup-card" data-name="vullaby vullaby">
{{#include ./pokemon/vullaby.md}}
</div>
<div class="lookup-card" data-name="vulpix vulpix">
{{#include ./pokemon/vulpix.md}}
</div>
...
<div class="lookup-card" data-name="wimpod wimpod">
{{#include ./pokemon/wimpod.md}}
</div>
<div class="lookup-card" data-name="wingull wingull">
{{#include ./pokemon/wingull.md}}
</div>
<div class="lookup-card" data-name="woobat woobat">
{{#include ./pokemon/woobat.md}}
</div>
<div class="lookup-card" data-name="wooper wooper">
{{#include ./pokemon/wooper.md}}
</div>
...
<div class="lookup-card" data-name="yamper yamper">
{{#include ./pokemon/yamper.md}}
</div>
<div class="lookup-card" data-name="yanma yanma">
{{#include ./pokemon/yanma.md}}
</div>

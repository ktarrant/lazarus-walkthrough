...
<label for="pokemon-tabs-primal-groudon-tab-0">Groudon</label>
<input type="radio" name="pokemon-tabs-primal-groudon-group" id="pokemon-tabs-primal-groudon-tab-1" checked>
<label for="pokemon-tabs-primal-groudon-tab-1">Primal Groudon</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-primal-groudon-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-primal-groudon-panel-1">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="primal-groudon" /> Caught</label>
...
<style>
#pokemon-tabs-primal-groudon-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-primal-groudon-panel-0 { display: block; }
#pokemon-tabs-primal-groudon-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-primal-groudon-panel-1 { display: block; }
</style>
</details>

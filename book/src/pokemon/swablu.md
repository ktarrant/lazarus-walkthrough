...
<input type="radio" name="pokemon-tabs-swablu-group" id="pokemon-tabs-swablu-tab-1">
<label for="pokemon-tabs-swablu-tab-1">Altaria</label>
<input type="radio" name="pokemon-tabs-swablu-group" id="pokemon-tabs-swablu-tab-2">
...
<style>
#pokemon-tabs-swablu-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-swablu-panel-0 { display: block; }

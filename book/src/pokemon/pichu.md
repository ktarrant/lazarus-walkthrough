...
<summary>Pichu (#248)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-pichu">
<input type="radio" name="pokemon-tabs-pichu-group" id="pokemon-tabs-pichu-tab-0" checked>
<label for="pokemon-tabs-pichu-tab-0">Pichu</label>
<input type="radio" name="pokemon-tabs-pichu-group" id="pokemon-tabs-pichu-tab-1">
<label for="pokemon-tabs-pichu-tab-1">Pikachu</label>
<input type="radio" name="pokemon-tabs-pichu-group" id="pokemon-tabs-pichu-tab-2">
<label for="pokemon-tabs-pichu-tab-2">Raichu</label>
<input type="radio" name="pokemon-tabs-pichu-group" id="pokemon-tabs-pichu-tab-3">
<label for="pokemon-tabs-pichu-tab-3">Mega Raichu X</label>
<input type="radio" name="pokemon-tabs-pichu-group" id="pokemon-tabs-pichu-tab-4">
<label for="pokemon-tabs-pichu-tab-4">Mega Raichu Y</label>
<input type="radio" name="pokemon-tabs-pichu-group" id="pokemon-tabs-pichu-tab-5">
<label for="pokemon-tabs-pichu-tab-5">Alolan Raichu</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-panel-1">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-panel-2">
Types: Electric • Egg Groups: Field / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-panel-3">
Types: Electric • Egg Groups: Field / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-panel-4">
Types: Electric • Egg Groups: Field / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-panel-5">
...
<style>
#pokemon-tabs-pichu-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-panel-0 { display: block; }
#pokemon-tabs-pichu-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-panel-1 { display: block; }
#pokemon-tabs-pichu-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-panel-2 { display: block; }
#pokemon-tabs-pichu-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-panel-3 { display: block; }
#pokemon-tabs-pichu-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-panel-4 { display: block; }
#pokemon-tabs-pichu-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-panel-5 { display: block; }
</style>
</details>

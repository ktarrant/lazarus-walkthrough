<div class="pokemon-tabs" id="pokemon-tabs-pichu-172">
<input type="radio" name="pokemon-tabs-pichu-172-group" id="pokemon-tabs-pichu-172-tab-0" checked>
<label for="pokemon-tabs-pichu-172-tab-0">Pichu</label>
<input type="radio" name="pokemon-tabs-pichu-172-group" id="pokemon-tabs-pichu-172-tab-1">
<label for="pokemon-tabs-pichu-172-tab-1">Pikachu</label>
<input type="radio" name="pokemon-tabs-pichu-172-group" id="pokemon-tabs-pichu-172-tab-2">
<label for="pokemon-tabs-pichu-172-tab-2">Raichu</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-172-panel-0">
## Pichu (#172)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-172-panel-1">
## Pikachu (#025)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pichu-172-panel-2">
## Raichu (#026)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-pichu-172-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-172-panel-0 { display: block; }
#pokemon-tabs-pichu-172-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-172-panel-1 { display: block; }
#pokemon-tabs-pichu-172-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-pichu-172-panel-2 { display: block; }
</style>

...
<label for="pokemon-tabs-goomy-tab-1">Sliggoo</label>
<input type="radio" name="pokemon-tabs-goomy-group" id="pokemon-tabs-goomy-tab-2">
<label for="pokemon-tabs-goomy-tab-2">Goodra</label>
<input type="radio" name="pokemon-tabs-goomy-group" id="pokemon-tabs-goomy-tab-3">
<label for="pokemon-tabs-goomy-tab-3">Hisuian Sliggoo</label>
<input type="radio" name="pokemon-tabs-goomy-group" id="pokemon-tabs-goomy-tab-4">
<label for="pokemon-tabs-goomy-tab-4">Hisuian Goodra</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-goomy-panel-3">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-goomy-panel-4">
Types: Dragon / Steel • Egg Groups: Dragon
...
#pokemon-tabs-goomy-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-goomy-panel-3 { display: block; }
#pokemon-tabs-goomy-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-goomy-panel-4 { display: block; }
</style>
</details>

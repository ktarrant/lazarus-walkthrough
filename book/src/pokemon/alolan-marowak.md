...
<summary>Alolan Marowak (#058)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-alolan-marowak">
<input type="radio" name="pokemon-tabs-alolan-marowak-group" id="pokemon-tabs-alolan-marowak-tab-0">
<label for="pokemon-tabs-alolan-marowak-tab-0">Cubone</label>
<input type="radio" name="pokemon-tabs-alolan-marowak-group" id="pokemon-tabs-alolan-marowak-tab-1">
<label for="pokemon-tabs-alolan-marowak-tab-1">Marowak</label>
<input type="radio" name="pokemon-tabs-alolan-marowak-group" id="pokemon-tabs-alolan-marowak-tab-2" checked>
<label for="pokemon-tabs-alolan-marowak-tab-2">Alolan Marowak</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-marowak-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="cubone" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-marowak-panel-1">
Types: Ground • Egg Groups: Monster
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="marowak" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-marowak-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="alolan-marowak" /> Caught</label>
...
<style>
#pokemon-tabs-alolan-marowak-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-marowak-panel-0 { display: block; }
#pokemon-tabs-alolan-marowak-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-marowak-panel-1 { display: block; }
#pokemon-tabs-alolan-marowak-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-marowak-panel-2 { display: block; }
</style>
</details>

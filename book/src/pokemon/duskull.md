...
<input type="radio" name="pokemon-tabs-duskull-group" id="pokemon-tabs-duskull-tab-1">
<label for="pokemon-tabs-duskull-tab-1">Dusclops</label>
<input type="radio" name="pokemon-tabs-duskull-group" id="pokemon-tabs-duskull-tab-2">
...
<style>
#pokemon-tabs-duskull-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-duskull-panel-0 { display: block; }

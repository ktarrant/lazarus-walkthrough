...
<input type="radio" name="pokemon-tabs-mega-cyclizar-v-group" id="pokemon-tabs-mega-cyclizar-v-tab-1">
<label for="pokemon-tabs-mega-cyclizar-v-tab-1">Mega Cyclizar S</label>
<input type="radio" name="pokemon-tabs-mega-cyclizar-v-group" id="pokemon-tabs-mega-cyclizar-v-tab-2" checked>
...
<style>
#pokemon-tabs-mega-cyclizar-v-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-cyclizar-v-panel-0 { display: block; }

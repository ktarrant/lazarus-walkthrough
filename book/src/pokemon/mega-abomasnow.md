...
<summary>Mega Abomasnow (#393)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-mega-abomasnow">
<input type="radio" name="pokemon-tabs-mega-abomasnow-group" id="pokemon-tabs-mega-abomasnow-tab-0">
<label for="pokemon-tabs-mega-abomasnow-tab-0">Snover</label>
<input type="radio" name="pokemon-tabs-mega-abomasnow-group" id="pokemon-tabs-mega-abomasnow-tab-1">
<label for="pokemon-tabs-mega-abomasnow-tab-1">Abomasnow</label>
<input type="radio" name="pokemon-tabs-mega-abomasnow-group" id="pokemon-tabs-mega-abomasnow-tab-2" checked>
<label for="pokemon-tabs-mega-abomasnow-tab-2">Mega Abomasnow</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-abomasnow-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-abomasnow-panel-1">
Types: Grass / Ice • Egg Groups: Grass / Monster
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-abomasnow-panel-2">
Types: Grass / Ice • Egg Groups: Grass / Monster
...
<style>
#pokemon-tabs-mega-abomasnow-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-abomasnow-panel-0 { display: block; }
#pokemon-tabs-mega-abomasnow-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-abomasnow-panel-1 { display: block; }
#pokemon-tabs-mega-abomasnow-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-abomasnow-panel-2 { display: block; }
</style>
</details>

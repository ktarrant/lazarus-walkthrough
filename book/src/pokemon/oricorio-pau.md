...
<summary>Oricorio Pa'u (#096)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-oricorio-pau">
<input type="radio" name="pokemon-tabs-oricorio-pau-group" id="pokemon-tabs-oricorio-pau-tab-0">
<label for="pokemon-tabs-oricorio-pau-tab-0">Oricorio Baile</label>
<input type="radio" name="pokemon-tabs-oricorio-pau-group" id="pokemon-tabs-oricorio-pau-tab-1">
<label for="pokemon-tabs-oricorio-pau-tab-1">Oricorio Pom-Pom</label>
<input type="radio" name="pokemon-tabs-oricorio-pau-group" id="pokemon-tabs-oricorio-pau-tab-2" checked>
<label for="pokemon-tabs-oricorio-pau-tab-2">Oricorio Pa'u</label>
<input type="radio" name="pokemon-tabs-oricorio-pau-group" id="pokemon-tabs-oricorio-pau-tab-3">
<label for="pokemon-tabs-oricorio-pau-tab-3">Oricorio Sensu</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-oricorio-pau-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="oricorio-baile" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-oricorio-pau-panel-1">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="oricorio-pom-pom" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-oricorio-pau-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="oricorio-pau" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-oricorio-pau-panel-3">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="oricorio-sensu" /> Caught</label>
...
<style>
#pokemon-tabs-oricorio-pau-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-oricorio-pau-panel-0 { display: block; }
#pokemon-tabs-oricorio-pau-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-oricorio-pau-panel-1 { display: block; }
#pokemon-tabs-oricorio-pau-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-oricorio-pau-panel-2 { display: block; }
#pokemon-tabs-oricorio-pau-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-oricorio-pau-panel-3 { display: block; }
</style>
</details>

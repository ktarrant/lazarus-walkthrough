...
<input type="radio" name="pokemon-tabs-incineroar-group" id="pokemon-tabs-incineroar-tab-1">
<label for="pokemon-tabs-incineroar-tab-1">Torracat</label>
<input type="radio" name="pokemon-tabs-incineroar-group" id="pokemon-tabs-incineroar-tab-2" checked>
...
<style>
#pokemon-tabs-incineroar-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-incineroar-panel-0 { display: block; }

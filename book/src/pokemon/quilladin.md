...
<input type="radio" name="pokemon-tabs-quilladin-group" id="pokemon-tabs-quilladin-tab-1" checked>
<label for="pokemon-tabs-quilladin-tab-1">Quilladin</label>
<input type="radio" name="pokemon-tabs-quilladin-group" id="pokemon-tabs-quilladin-tab-2">
<label for="pokemon-tabs-quilladin-tab-2">Chesnaught</label>
<input type="radio" name="pokemon-tabs-quilladin-group" id="pokemon-tabs-quilladin-tab-3">
...
<style>
#pokemon-tabs-quilladin-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-quilladin-panel-0 { display: block; }
#pokemon-tabs-quilladin-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-quilladin-panel-1 { display: block; }

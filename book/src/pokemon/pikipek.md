...
<label for="pokemon-tabs-pikipek-tab-0">Pikipek</label>
<input type="radio" name="pokemon-tabs-pikipek-group" id="pokemon-tabs-pikipek-tab-1">
<label for="pokemon-tabs-pikipek-tab-1">Trumbeak</label>
<input type="radio" name="pokemon-tabs-pikipek-group" id="pokemon-tabs-pikipek-tab-2">
<label for="pokemon-tabs-pikipek-tab-2">Toucannon</label>
<input type="radio" name="pokemon-tabs-pikipek-group" id="pokemon-tabs-pikipek-tab-3">
<label for="pokemon-tabs-pikipek-tab-3">Mega Toucannon</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-pikipek-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pikipek-panel-1">
Types: Normal / Flying • Egg Groups: Flying
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pikipek-panel-2">
Types: Normal / Flying • Egg Groups: Flying
...
<div class="pokemon-tab-panel" id="pokemon-tabs-pikipek-panel-3">
...
<style>
#pokemon-tabs-pikipek-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-pikipek-panel-0 { display: block; }
#pokemon-tabs-pikipek-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-pikipek-panel-1 { display: block; }
#pokemon-tabs-pikipek-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-pikipek-panel-2 { display: block; }
#pokemon-tabs-pikipek-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-pikipek-panel-3 { display: block; }
</style>
</details>

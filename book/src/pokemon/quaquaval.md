...
<input type="radio" name="pokemon-tabs-quaquaval-group" id="pokemon-tabs-quaquaval-tab-1">
<label for="pokemon-tabs-quaquaval-tab-1">Quaxwell</label>
<input type="radio" name="pokemon-tabs-quaquaval-group" id="pokemon-tabs-quaquaval-tab-2" checked>
...
<style>
#pokemon-tabs-quaquaval-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-quaquaval-panel-0 { display: block; }

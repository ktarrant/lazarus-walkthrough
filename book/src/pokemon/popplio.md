...
<input type="radio" name="pokemon-tabs-popplio-group" id="pokemon-tabs-popplio-tab-1">
<label for="pokemon-tabs-popplio-tab-1">Brionne</label>
<input type="radio" name="pokemon-tabs-popplio-group" id="pokemon-tabs-popplio-tab-2">
...
<style>
#pokemon-tabs-popplio-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-popplio-panel-0 { display: block; }

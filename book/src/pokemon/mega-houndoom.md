...
<summary>Mega Houndoom (#170)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-mega-houndoom">
<input type="radio" name="pokemon-tabs-mega-houndoom-group" id="pokemon-tabs-mega-houndoom-tab-0">
<label for="pokemon-tabs-mega-houndoom-tab-0">Houndour</label>
<input type="radio" name="pokemon-tabs-mega-houndoom-group" id="pokemon-tabs-mega-houndoom-tab-1">
<label for="pokemon-tabs-mega-houndoom-tab-1">Houndoom</label>
<input type="radio" name="pokemon-tabs-mega-houndoom-group" id="pokemon-tabs-mega-houndoom-tab-2" checked>
<label for="pokemon-tabs-mega-houndoom-tab-2">Mega Houndoom</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-houndoom-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="houndour" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-houndoom-panel-1">
Types: Dark / Fire • Egg Groups: Field
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="houndoom" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-houndoom-panel-2">
Types: Dark / Fire • Egg Groups: Field
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="mega-houndoom" /> Caught</label>
...
<style>
#pokemon-tabs-mega-houndoom-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-houndoom-panel-0 { display: block; }
#pokemon-tabs-mega-houndoom-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-houndoom-panel-1 { display: block; }
#pokemon-tabs-mega-houndoom-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-houndoom-panel-2 { display: block; }
</style>
</details>

...
<label for="pokemon-tabs-rayquaza-tab-0">Rayquaza</label>
<input type="radio" name="pokemon-tabs-rayquaza-group" id="pokemon-tabs-rayquaza-tab-1">
<label for="pokemon-tabs-rayquaza-tab-1">Mega Rayquaza</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-rayquaza-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="rayquaza" /> Caught</label>
...
| Total | <span class="stat-value stat-high">680</span> |

**Level-Up Moves**
- <a href="move-lookup.html?q=twister">Twister</a> (Lv 1)
- <a href="move-lookup.html?q=scary-face">Scary Face</a> (Lv 5)
- <a href="move-lookup.html?q=ancient-power">Ancient Power</a> (Lv 15)
- <a href="move-lookup.html?q=crunch">Crunch</a> (Lv 20)
- <a href="move-lookup.html?q=air-slash">Air Slash</a> (Lv 30)
- <a href="move-lookup.html?q=rest">Rest</a> (Lv 35)
- <a href="move-lookup.html?q=snarl">Snarl</a> (Lv 40)
- <a href="move-lookup.html?q=extreme-speed">Extreme Speed</a> (Lv 45)
- <a href="move-lookup.html?q=dragon-pulse">Dragon Pulse</a> (Lv 50)
- <a href="move-lookup.html?q=dragon-ascent">Dragon Ascent</a> (Lv 50)
- <a href="move-lookup.html?q=dragon-dance">Dragon Dance</a> (Lv 60)
- <a href="move-lookup.html?q=fly">Fly</a> (Lv 65)
- <a href="move-lookup.html?q=hyper-voice">Hyper Voice</a> (Lv 75)
- <a href="move-lookup.html?q=outrage">Outrage</a> (Lv 80)
- <a href="move-lookup.html?q=hyper-beam">Hyper Beam</a> (Lv 90)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-rayquaza-panel-1">
Types: Dragon / Flying • Egg Groups: -
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="mega-rayquaza" /> Caught</label>
...
| --- | --- |
| HP | <span class="stat-value stat-high">105</span> |
| Attack | <span class="stat-value stat-high">180</span> |
...
| Total | <span class="stat-value stat-high">780</span> |
...
<style>
#pokemon-tabs-rayquaza-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-rayquaza-panel-0 { display: block; }
#pokemon-tabs-rayquaza-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-rayquaza-panel-1 { display: block; }
</style>
</details>

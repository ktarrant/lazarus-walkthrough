...
<label for="pokemon-tabs-politoed-tab-0">Poliwag</label>
<input type="radio" name="pokemon-tabs-politoed-group" id="pokemon-tabs-politoed-tab-1">
<label for="pokemon-tabs-politoed-tab-1">Poliwhirl</label>
<input type="radio" name="pokemon-tabs-politoed-group" id="pokemon-tabs-politoed-tab-2">
<label for="pokemon-tabs-politoed-tab-2">Poliwrath</label>
<input type="radio" name="pokemon-tabs-politoed-group" id="pokemon-tabs-politoed-tab-3" checked>
<label for="pokemon-tabs-politoed-tab-3">Politoed</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-politoed-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-politoed-panel-1">
Types: Water • Egg Groups: Water 1
...
<div class="pokemon-tab-panel" id="pokemon-tabs-politoed-panel-2">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-politoed-panel-3">
...
<style>
#pokemon-tabs-politoed-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-politoed-panel-0 { display: block; }
#pokemon-tabs-politoed-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-politoed-panel-1 { display: block; }
#pokemon-tabs-politoed-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-politoed-panel-2 { display: block; }
#pokemon-tabs-politoed-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-politoed-panel-3 { display: block; }
</style>
</details>

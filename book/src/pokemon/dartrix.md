...
<label for="pokemon-tabs-dartrix-tab-0">Rowlet</label>
<input type="radio" name="pokemon-tabs-dartrix-group" id="pokemon-tabs-dartrix-tab-1" checked>
<label for="pokemon-tabs-dartrix-tab-1">Dartrix</label>
<input type="radio" name="pokemon-tabs-dartrix-group" id="pokemon-tabs-dartrix-tab-2">
<label for="pokemon-tabs-dartrix-tab-2">Hisuian Decidueye</label>
<input type="radio" name="pokemon-tabs-dartrix-group" id="pokemon-tabs-dartrix-tab-3">
<label for="pokemon-tabs-dartrix-tab-3">Decidueye</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-dartrix-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dartrix-panel-1">
Types: Grass / Flying • Egg Groups: Flying
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dartrix-panel-2">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dartrix-panel-3">
...
<style>
#pokemon-tabs-dartrix-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-dartrix-panel-0 { display: block; }
#pokemon-tabs-dartrix-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-dartrix-panel-1 { display: block; }
#pokemon-tabs-dartrix-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-dartrix-panel-2 { display: block; }
#pokemon-tabs-dartrix-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-dartrix-panel-3 { display: block; }
</style>
</details>

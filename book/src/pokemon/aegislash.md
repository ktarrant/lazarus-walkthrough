...
<summary>Aegislash (#151)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-aegislash">
<input type="radio" name="pokemon-tabs-aegislash-group" id="pokemon-tabs-aegislash-tab-0">
<label for="pokemon-tabs-aegislash-tab-0">Honedge</label>
<input type="radio" name="pokemon-tabs-aegislash-group" id="pokemon-tabs-aegislash-tab-1">
<label for="pokemon-tabs-aegislash-tab-1">Doublade</label>
<input type="radio" name="pokemon-tabs-aegislash-group" id="pokemon-tabs-aegislash-tab-2" checked>
<label for="pokemon-tabs-aegislash-tab-2">Aegislash</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-aegislash-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="honedge" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-aegislash-panel-1">
Types: Steel / Ghost • Egg Groups: Mineral
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="doublade" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-aegislash-panel-2">
Types: Steel / Ghost • Egg Groups: Mineral
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="aegislash" /> Caught</label>
...
<style>
#pokemon-tabs-aegislash-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-aegislash-panel-0 { display: block; }
#pokemon-tabs-aegislash-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-aegislash-panel-1 { display: block; }
#pokemon-tabs-aegislash-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-aegislash-panel-2 { display: block; }
</style>
</details>

...
<input type="radio" name="pokemon-tabs-silcoon-group" id="pokemon-tabs-silcoon-tab-0" checked>
<label for="pokemon-tabs-silcoon-tab-0">Silcoon</label>
<input type="radio" name="pokemon-tabs-silcoon-group" id="pokemon-tabs-silcoon-tab-1">
<label for="pokemon-tabs-silcoon-tab-1">Beautifly</label>

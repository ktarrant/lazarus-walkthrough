...
<input type="radio" name="pokemon-tabs-mega-gogoat-group" id="pokemon-tabs-mega-gogoat-tab-1">
<label for="pokemon-tabs-mega-gogoat-tab-1">Gogoat</label>
<input type="radio" name="pokemon-tabs-mega-gogoat-group" id="pokemon-tabs-mega-gogoat-tab-2" checked>
...
<style>
#pokemon-tabs-mega-gogoat-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-gogoat-panel-0 { display: block; }

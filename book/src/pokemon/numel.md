...
<input type="radio" name="pokemon-tabs-numel-group" id="pokemon-tabs-numel-tab-1">
<label for="pokemon-tabs-numel-tab-1">Camerupt</label>
<input type="radio" name="pokemon-tabs-numel-group" id="pokemon-tabs-numel-tab-2">
...
<style>
#pokemon-tabs-numel-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-numel-panel-0 { display: block; }

...
<summary>Mega Greninja (#018)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-mega-greninja">
<input type="radio" name="pokemon-tabs-mega-greninja-group" id="pokemon-tabs-mega-greninja-tab-0">
<label for="pokemon-tabs-mega-greninja-tab-0">Froakie</label>
<input type="radio" name="pokemon-tabs-mega-greninja-group" id="pokemon-tabs-mega-greninja-tab-1">
<label for="pokemon-tabs-mega-greninja-tab-1">Frogadier</label>
<input type="radio" name="pokemon-tabs-mega-greninja-group" id="pokemon-tabs-mega-greninja-tab-2">
<label for="pokemon-tabs-mega-greninja-tab-2">Greninja</label>
<input type="radio" name="pokemon-tabs-mega-greninja-group" id="pokemon-tabs-mega-greninja-tab-3" checked>
<label for="pokemon-tabs-mega-greninja-tab-3">Mega Greninja</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-greninja-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="froakie" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-greninja-panel-1">
Types: Water • Egg Groups: Water 1
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="frogadier" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-greninja-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="greninja" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-greninja-panel-3">
Types: Water / Dark • Egg Groups: Water 1
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="mega-greninja" /> Caught</label>
...
<style>
#pokemon-tabs-mega-greninja-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-greninja-panel-0 { display: block; }
#pokemon-tabs-mega-greninja-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-greninja-panel-1 { display: block; }
#pokemon-tabs-mega-greninja-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-greninja-panel-2 { display: block; }
#pokemon-tabs-mega-greninja-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-greninja-panel-3 { display: block; }
</style>
</details>

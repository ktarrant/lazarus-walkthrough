...
<summary>Dipplin (#067)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-dipplin">
<input type="radio" name="pokemon-tabs-dipplin-group" id="pokemon-tabs-dipplin-tab-0">
<label for="pokemon-tabs-dipplin-tab-0">Applin</label>
<input type="radio" name="pokemon-tabs-dipplin-group" id="pokemon-tabs-dipplin-tab-1">
<label for="pokemon-tabs-dipplin-tab-1">Flapple</label>
<input type="radio" name="pokemon-tabs-dipplin-group" id="pokemon-tabs-dipplin-tab-2">
<label for="pokemon-tabs-dipplin-tab-2">Appletun</label>
<input type="radio" name="pokemon-tabs-dipplin-group" id="pokemon-tabs-dipplin-tab-3" checked>
<label for="pokemon-tabs-dipplin-tab-3">Dipplin</label>
<input type="radio" name="pokemon-tabs-dipplin-group" id="pokemon-tabs-dipplin-tab-4">
<label for="pokemon-tabs-dipplin-tab-4">Hydrapple</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-dipplin-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dipplin-panel-1">
Types: Grass / Dragon • Egg Groups: Grass / Dragon
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dipplin-panel-2">
Types: Grass / Dragon • Egg Groups: Grass / Dragon
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dipplin-panel-3">
Types: Grass / Dragon • Egg Groups: Grass / Dragon
...
<div class="pokemon-tab-panel" id="pokemon-tabs-dipplin-panel-4">
Types: Grass / Dragon • Egg Groups: Grass / Dragon
...
<style>
#pokemon-tabs-dipplin-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-dipplin-panel-0 { display: block; }
#pokemon-tabs-dipplin-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-dipplin-panel-1 { display: block; }
#pokemon-tabs-dipplin-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-dipplin-panel-2 { display: block; }
#pokemon-tabs-dipplin-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-dipplin-panel-3 { display: block; }
#pokemon-tabs-dipplin-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-dipplin-panel-4 { display: block; }
</style>
</details>

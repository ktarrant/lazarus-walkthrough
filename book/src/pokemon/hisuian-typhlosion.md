...
<input type="radio" name="pokemon-tabs-hisuian-typhlosion-group" id="pokemon-tabs-hisuian-typhlosion-tab-1">
<label for="pokemon-tabs-hisuian-typhlosion-tab-1">Quilava</label>
<input type="radio" name="pokemon-tabs-hisuian-typhlosion-group" id="pokemon-tabs-hisuian-typhlosion-tab-2">
<label for="pokemon-tabs-hisuian-typhlosion-tab-2">Typhlosion</label>
<input type="radio" name="pokemon-tabs-hisuian-typhlosion-group" id="pokemon-tabs-hisuian-typhlosion-tab-3" checked>
...
<style>
#pokemon-tabs-hisuian-typhlosion-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-typhlosion-panel-0 { display: block; }
#pokemon-tabs-hisuian-typhlosion-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-typhlosion-panel-1 { display: block; }

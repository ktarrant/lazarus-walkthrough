...
<input type="radio" name="pokemon-tabs-jumpluff-group" id="pokemon-tabs-jumpluff-tab-1">
<label for="pokemon-tabs-jumpluff-tab-1">Skiploom</label>
<input type="radio" name="pokemon-tabs-jumpluff-group" id="pokemon-tabs-jumpluff-tab-2" checked>
...
<style>
#pokemon-tabs-jumpluff-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-jumpluff-panel-0 { display: block; }

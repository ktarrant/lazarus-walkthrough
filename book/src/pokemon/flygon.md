...
<label for="pokemon-tabs-flygon-tab-0">Trapinch</label>
<input type="radio" name="pokemon-tabs-flygon-group" id="pokemon-tabs-flygon-tab-1">
<label for="pokemon-tabs-flygon-tab-1">Vibrava</label>
<input type="radio" name="pokemon-tabs-flygon-group" id="pokemon-tabs-flygon-tab-2" checked>
<label for="pokemon-tabs-flygon-tab-2">Flygon</label>
<input type="radio" name="pokemon-tabs-flygon-group" id="pokemon-tabs-flygon-tab-3">
<label for="pokemon-tabs-flygon-tab-3">Mega Flygon</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-flygon-panel-0">
## Trapinch (#321)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flygon-panel-1">
## Vibrava (#322)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flygon-panel-2">
## Flygon (#323)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flygon-panel-3">
## Mega Flygon (#323)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-flygon-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-flygon-panel-0 { display: block; }
#pokemon-tabs-flygon-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-flygon-panel-1 { display: block; }
#pokemon-tabs-flygon-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-flygon-panel-2 { display: block; }
#pokemon-tabs-flygon-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-flygon-panel-3 { display: block; }
</style>

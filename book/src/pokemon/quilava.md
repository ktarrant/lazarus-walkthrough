...
<label for="pokemon-tabs-quilava-tab-0">Cyndaquil</label>
<input type="radio" name="pokemon-tabs-quilava-group" id="pokemon-tabs-quilava-tab-1" checked>
<label for="pokemon-tabs-quilava-tab-1">Quilava</label>
<input type="radio" name="pokemon-tabs-quilava-group" id="pokemon-tabs-quilava-tab-2">
<label for="pokemon-tabs-quilava-tab-2">Typhlosion</label>
<input type="radio" name="pokemon-tabs-quilava-group" id="pokemon-tabs-quilava-tab-3">
<label for="pokemon-tabs-quilava-tab-3">Hisuian Typhlosion</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-quilava-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-quilava-panel-1">
Types: Fire • Egg Groups: Field
...
<div class="pokemon-tab-panel" id="pokemon-tabs-quilava-panel-2">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-quilava-panel-3">
...
<style>
#pokemon-tabs-quilava-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-quilava-panel-0 { display: block; }
#pokemon-tabs-quilava-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-quilava-panel-1 { display: block; }
#pokemon-tabs-quilava-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-quilava-panel-2 { display: block; }
#pokemon-tabs-quilava-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-quilava-panel-3 { display: block; }
</style>
</details>

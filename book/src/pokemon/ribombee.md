...
<label for="pokemon-tabs-ribombee-tab-0">Cutiefly</label>
<input type="radio" name="pokemon-tabs-ribombee-group" id="pokemon-tabs-ribombee-tab-1" checked>
<label for="pokemon-tabs-ribombee-tab-1">Ribombee</label>
<input type="radio" name="pokemon-tabs-ribombee-group" id="pokemon-tabs-ribombee-tab-2">
<label for="pokemon-tabs-ribombee-tab-2">Mega Ribombee</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-ribombee-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-ribombee-panel-1">
Types: Bug / Fairy • Egg Groups: Bug / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-ribombee-panel-2">
Types: Bug / Fairy • Egg Groups: Bug / Fairy
...
<style>
#pokemon-tabs-ribombee-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-ribombee-panel-0 { display: block; }
#pokemon-tabs-ribombee-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-ribombee-panel-1 { display: block; }
#pokemon-tabs-ribombee-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-ribombee-panel-2 { display: block; }
</style>
</details>

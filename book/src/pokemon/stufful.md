<div class="pokemon-tabs" id="pokemon-tabs-stufful-759">
<input type="radio" name="pokemon-tabs-stufful-759-group" id="pokemon-tabs-stufful-759-tab-0" checked>
<label for="pokemon-tabs-stufful-759-tab-0">Stufful</label>
<input type="radio" name="pokemon-tabs-stufful-759-group" id="pokemon-tabs-stufful-759-tab-1">
<label for="pokemon-tabs-stufful-759-tab-1">Bewear</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-stufful-759-panel-0">
## Stufful (#759)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-stufful-759-panel-1">
## Bewear (#760)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-stufful-759-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-stufful-759-panel-0 { display: block; }
#pokemon-tabs-stufful-759-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-stufful-759-panel-1 { display: block; }
</style>

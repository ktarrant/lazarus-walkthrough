...
<summary>Delphox (#015)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-delphox">
<input type="radio" name="pokemon-tabs-delphox-group" id="pokemon-tabs-delphox-tab-0">
<label for="pokemon-tabs-delphox-tab-0">Fennekin</label>
<input type="radio" name="pokemon-tabs-delphox-group" id="pokemon-tabs-delphox-tab-1">
<label for="pokemon-tabs-delphox-tab-1">Braixen</label>
<input type="radio" name="pokemon-tabs-delphox-group" id="pokemon-tabs-delphox-tab-2" checked>
<label for="pokemon-tabs-delphox-tab-2">Delphox</label>
<input type="radio" name="pokemon-tabs-delphox-group" id="pokemon-tabs-delphox-tab-3">
<label for="pokemon-tabs-delphox-tab-3">Mega Delphox</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-delphox-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="fennekin" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-delphox-panel-1">
Types: Fire • Egg Groups: Field
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="braixen" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-delphox-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="delphox" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-delphox-panel-3">
Types: Fire / Psychic • Egg Groups: Field
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="mega-delphox" /> Caught</label>
...
| Attack | <span class="stat-value stat-mid">69</span> |
| Defense | <span class="stat-value stat-mid">72</span> |
| Sp. Atk | <span class="stat-value stat-high">149</span> |
| Sp. Def | <span class="stat-value stat-high">120</span> |
| Speed | <span class="stat-value stat-high">129</span> |
...
<style>
#pokemon-tabs-delphox-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-delphox-panel-0 { display: block; }
#pokemon-tabs-delphox-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-delphox-panel-1 { display: block; }
#pokemon-tabs-delphox-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-delphox-panel-2 { display: block; }
#pokemon-tabs-delphox-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-delphox-panel-3 { display: block; }
</style>
</details>

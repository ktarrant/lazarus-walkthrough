<div class="pokemon-tabs" id="pokemon-tabs-musharna-518">
<input type="radio" name="pokemon-tabs-musharna-518-group" id="pokemon-tabs-musharna-518-tab-0">
<label for="pokemon-tabs-musharna-518-tab-0">Munna</label>
<input type="radio" name="pokemon-tabs-musharna-518-group" id="pokemon-tabs-musharna-518-tab-1" checked>
<label for="pokemon-tabs-musharna-518-tab-1">Musharna</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-musharna-518-panel-0">
## Munna (#517)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-musharna-518-panel-1">
## Musharna (#518)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-musharna-518-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-musharna-518-panel-0 { display: block; }
#pokemon-tabs-musharna-518-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-musharna-518-panel-1 { display: block; }
</style>

...
<label for="pokemon-tabs-skrelp-tab-0">Skrelp</label>
<input type="radio" name="pokemon-tabs-skrelp-group" id="pokemon-tabs-skrelp-tab-1">
...
<style>
#pokemon-tabs-skrelp-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-skrelp-panel-0 { display: block; }
#pokemon-tabs-skrelp-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-skrelp-panel-1 { display: block; }
</style>
</details>

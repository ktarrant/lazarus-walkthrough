...
<input type="radio" name="pokemon-tabs-mega-tyranitar-group" id="pokemon-tabs-mega-tyranitar-tab-1">
<label for="pokemon-tabs-mega-tyranitar-tab-1">Pupitar</label>
<input type="radio" name="pokemon-tabs-mega-tyranitar-group" id="pokemon-tabs-mega-tyranitar-tab-2">
<label for="pokemon-tabs-mega-tyranitar-tab-2">Tyranitar</label>
<input type="radio" name="pokemon-tabs-mega-tyranitar-group" id="pokemon-tabs-mega-tyranitar-tab-3" checked>
...
<style>
#pokemon-tabs-mega-tyranitar-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-tyranitar-panel-0 { display: block; }
#pokemon-tabs-mega-tyranitar-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-tyranitar-panel-1 { display: block; }

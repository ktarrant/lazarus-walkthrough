...
<input type="radio" name="pokemon-tabs-sealeo-group" id="pokemon-tabs-sealeo-tab-1" checked>
<label for="pokemon-tabs-sealeo-tab-1">Sealeo</label>
<input type="radio" name="pokemon-tabs-sealeo-group" id="pokemon-tabs-sealeo-tab-2">
...
<style>
#pokemon-tabs-sealeo-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-sealeo-panel-0 { display: block; }

...
<label for="pokemon-tabs-snorunt-tab-1">Glalie</label>
<input type="radio" name="pokemon-tabs-snorunt-group" id="pokemon-tabs-snorunt-tab-2">
<label for="pokemon-tabs-snorunt-tab-2">Mega Glalie</label>
<input type="radio" name="pokemon-tabs-snorunt-group" id="pokemon-tabs-snorunt-tab-3">
<label for="pokemon-tabs-snorunt-tab-3">Froslass</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-snorunt-panel-3">
...
#pokemon-tabs-snorunt-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-snorunt-panel-3 { display: block; }
</style>
</details>

...
<input type="radio" name="pokemon-tabs-reuniclus-group" id="pokemon-tabs-reuniclus-tab-1">
<label for="pokemon-tabs-reuniclus-tab-1">Duosion</label>
<input type="radio" name="pokemon-tabs-reuniclus-group" id="pokemon-tabs-reuniclus-tab-2" checked>
...
<style>
#pokemon-tabs-reuniclus-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-reuniclus-panel-0 { display: block; }

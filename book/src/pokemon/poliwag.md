<div class="pokemon-tabs" id="pokemon-tabs-poliwag-60">
<input type="radio" name="pokemon-tabs-poliwag-60-group" id="pokemon-tabs-poliwag-60-tab-0" checked>
<label for="pokemon-tabs-poliwag-60-tab-0">Poliwag</label>
<input type="radio" name="pokemon-tabs-poliwag-60-group" id="pokemon-tabs-poliwag-60-tab-1">
<label for="pokemon-tabs-poliwag-60-tab-1">Poliwhirl</label>
<input type="radio" name="pokemon-tabs-poliwag-60-group" id="pokemon-tabs-poliwag-60-tab-2">
<label for="pokemon-tabs-poliwag-60-tab-2">Poliwrath</label>
<input type="radio" name="pokemon-tabs-poliwag-60-group" id="pokemon-tabs-poliwag-60-tab-3">
<label for="pokemon-tabs-poliwag-60-tab-3">Politoed</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-poliwag-60-panel-0">
## Poliwag (#060)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-poliwag-60-panel-1">
## Poliwhirl (#061)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-poliwag-60-panel-2">
## Poliwrath (#062)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-poliwag-60-panel-3">
## Politoed (#186)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-poliwag-60-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-poliwag-60-panel-0 { display: block; }
#pokemon-tabs-poliwag-60-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-poliwag-60-panel-1 { display: block; }
#pokemon-tabs-poliwag-60-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-poliwag-60-panel-2 { display: block; }
#pokemon-tabs-poliwag-60-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-poliwag-60-panel-3 { display: block; }
</style>

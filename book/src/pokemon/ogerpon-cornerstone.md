...
<input type="radio" name="pokemon-tabs-ogerpon-cornerstone-group" id="pokemon-tabs-ogerpon-cornerstone-tab-1" checked>
<label for="pokemon-tabs-ogerpon-cornerstone-tab-1">Ogerpon Cornerstone</label>
<input type="radio" name="pokemon-tabs-ogerpon-cornerstone-group" id="pokemon-tabs-ogerpon-cornerstone-tab-2">
<label for="pokemon-tabs-ogerpon-cornerstone-tab-2">Ogerpon Hearthflame</label>
<input type="radio" name="pokemon-tabs-ogerpon-cornerstone-group" id="pokemon-tabs-ogerpon-cornerstone-tab-3">
...
<style>
#pokemon-tabs-ogerpon-cornerstone-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-ogerpon-cornerstone-panel-0 { display: block; }
#pokemon-tabs-ogerpon-cornerstone-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-ogerpon-cornerstone-panel-1 { display: block; }

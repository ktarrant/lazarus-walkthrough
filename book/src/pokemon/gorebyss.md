...
<input type="radio" name="pokemon-tabs-gorebyss-group" id="pokemon-tabs-gorebyss-tab-1">
<label for="pokemon-tabs-gorebyss-tab-1">Huntail</label>
<input type="radio" name="pokemon-tabs-gorebyss-group" id="pokemon-tabs-gorebyss-tab-2" checked>
...
<style>
#pokemon-tabs-gorebyss-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-gorebyss-panel-0 { display: block; }

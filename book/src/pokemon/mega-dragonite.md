...
<input type="radio" name="pokemon-tabs-mega-dragonite-group" id="pokemon-tabs-mega-dragonite-tab-1">
<label for="pokemon-tabs-mega-dragonite-tab-1">Dragonair</label>
<input type="radio" name="pokemon-tabs-mega-dragonite-group" id="pokemon-tabs-mega-dragonite-tab-2">
<label for="pokemon-tabs-mega-dragonite-tab-2">Dragonite</label>
<input type="radio" name="pokemon-tabs-mega-dragonite-group" id="pokemon-tabs-mega-dragonite-tab-3" checked>
...
<style>
#pokemon-tabs-mega-dragonite-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-dragonite-panel-0 { display: block; }
#pokemon-tabs-mega-dragonite-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-dragonite-panel-1 { display: block; }

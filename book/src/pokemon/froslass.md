...
<input type="radio" name="pokemon-tabs-froslass-group" id="pokemon-tabs-froslass-tab-1">
<label for="pokemon-tabs-froslass-tab-1">Glalie</label>
<input type="radio" name="pokemon-tabs-froslass-group" id="pokemon-tabs-froslass-tab-2">
<label for="pokemon-tabs-froslass-tab-2">Mega Glalie</label>
<input type="radio" name="pokemon-tabs-froslass-group" id="pokemon-tabs-froslass-tab-3" checked>
...
<style>
#pokemon-tabs-froslass-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-froslass-panel-0 { display: block; }
#pokemon-tabs-froslass-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-froslass-panel-1 { display: block; }

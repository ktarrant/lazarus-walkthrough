...
<input type="radio" name="pokemon-tabs-huntail-group" id="pokemon-tabs-huntail-tab-1">
<label for="pokemon-tabs-huntail-tab-1">Gorebyss</label>
<input type="radio" name="pokemon-tabs-huntail-group" id="pokemon-tabs-huntail-tab-2" checked>
<label for="pokemon-tabs-huntail-tab-2">Huntail</label>

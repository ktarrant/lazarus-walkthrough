<div class="pokemon-tabs" id="pokemon-tabs-huntail-367">
<input type="radio" name="pokemon-tabs-huntail-367-group" id="pokemon-tabs-huntail-367-tab-0">
<label for="pokemon-tabs-huntail-367-tab-0">Clamperl</label>
<input type="radio" name="pokemon-tabs-huntail-367-group" id="pokemon-tabs-huntail-367-tab-1" checked>
<label for="pokemon-tabs-huntail-367-tab-1">Huntail</label>
<input type="radio" name="pokemon-tabs-huntail-367-group" id="pokemon-tabs-huntail-367-tab-2">
<label for="pokemon-tabs-huntail-367-tab-2">Gorebyss</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-huntail-367-panel-0">
## Clamperl (#366)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-huntail-367-panel-1">
## Huntail (#367)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-huntail-367-panel-2">
## Gorebyss (#368)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-huntail-367-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-huntail-367-panel-0 { display: block; }
#pokemon-tabs-huntail-367-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-huntail-367-panel-1 { display: block; }
#pokemon-tabs-huntail-367-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-huntail-367-panel-2 { display: block; }
</style>

...
<input type="radio" name="pokemon-tabs-magikarp-group" id="pokemon-tabs-magikarp-tab-1">
<label for="pokemon-tabs-magikarp-tab-1">Gyarados</label>
<input type="radio" name="pokemon-tabs-magikarp-group" id="pokemon-tabs-magikarp-tab-2">
...
<style>
#pokemon-tabs-magikarp-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-magikarp-panel-0 { display: block; }

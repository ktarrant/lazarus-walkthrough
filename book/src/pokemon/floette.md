...
<input type="radio" name="pokemon-tabs-floette-group" id="pokemon-tabs-floette-tab-1" checked>
<label for="pokemon-tabs-floette-tab-1">Floette</label>
<input type="radio" name="pokemon-tabs-floette-group" id="pokemon-tabs-floette-tab-2">

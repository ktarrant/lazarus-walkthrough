...
<summary>Mega Ribombee (#070)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-mega-ribombee">
<input type="radio" name="pokemon-tabs-mega-ribombee-group" id="pokemon-tabs-mega-ribombee-tab-0">
<label for="pokemon-tabs-mega-ribombee-tab-0">Cutiefly</label>
<input type="radio" name="pokemon-tabs-mega-ribombee-group" id="pokemon-tabs-mega-ribombee-tab-1">
<label for="pokemon-tabs-mega-ribombee-tab-1">Ribombee</label>
<input type="radio" name="pokemon-tabs-mega-ribombee-group" id="pokemon-tabs-mega-ribombee-tab-2" checked>
<label for="pokemon-tabs-mega-ribombee-tab-2">Mega Ribombee</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-ribombee-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="cutiefly" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-ribombee-panel-1">
Types: Bug / Fairy • Egg Groups: Bug / Fairy
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="ribombee" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-mega-ribombee-panel-2">
Types: Bug / Fairy • Egg Groups: Bug / Fairy
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="mega-ribombee" /> Caught</label>
...
| Speed | <span class="stat-value stat-high">139</span> |
...
<style>
#pokemon-tabs-mega-ribombee-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-ribombee-panel-0 { display: block; }
#pokemon-tabs-mega-ribombee-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-ribombee-panel-1 { display: block; }
#pokemon-tabs-mega-ribombee-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-ribombee-panel-2 { display: block; }
</style>
</details>

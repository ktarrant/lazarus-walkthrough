...
<summary>Jolteon (#085)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-jolteon">
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-0">
<label for="pokemon-tabs-jolteon-tab-0">Eevee</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-1">
<label for="pokemon-tabs-jolteon-tab-1">Vaporeon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-2" checked>
<label for="pokemon-tabs-jolteon-tab-2">Jolteon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-3">
<label for="pokemon-tabs-jolteon-tab-3">Flareon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-4">
<label for="pokemon-tabs-jolteon-tab-4">Espeon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-5">
<label for="pokemon-tabs-jolteon-tab-5">Umbreon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-6">
<label for="pokemon-tabs-jolteon-tab-6">Leafeon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-7">
<label for="pokemon-tabs-jolteon-tab-7">Glaceon</label>
<input type="radio" name="pokemon-tabs-jolteon-group" id="pokemon-tabs-jolteon-tab-8">
<label for="pokemon-tabs-jolteon-tab-8">Sylveon</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="eevee" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-1">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="vaporeon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="jolteon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-3">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="flareon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-4">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="espeon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-5">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="umbreon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-6">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="leafeon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-7">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="glaceon" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-jolteon-panel-8">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="sylveon" /> Caught</label>
...
<style>
#pokemon-tabs-jolteon-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-0 { display: block; }
#pokemon-tabs-jolteon-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-1 { display: block; }
#pokemon-tabs-jolteon-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-2 { display: block; }
#pokemon-tabs-jolteon-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-3 { display: block; }
#pokemon-tabs-jolteon-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-4 { display: block; }
#pokemon-tabs-jolteon-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-5 { display: block; }
#pokemon-tabs-jolteon-tab-6:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-6 { display: block; }
#pokemon-tabs-jolteon-tab-7:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-7 { display: block; }
#pokemon-tabs-jolteon-tab-8:checked ~ .pokemon-tab-panels #pokemon-tabs-jolteon-panel-8 { display: block; }
</style>
</details>

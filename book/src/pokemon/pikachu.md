...
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-0" checked>
<label for="pokemon-tabs-pikachu-tab-0">Pikachu</label>
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-1">
<label for="pokemon-tabs-pikachu-tab-1">Raichu</label>

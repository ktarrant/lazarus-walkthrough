...
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-1" checked>
<label for="pokemon-tabs-pikachu-tab-1">Pikachu</label>
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-2">
<label for="pokemon-tabs-pikachu-tab-2">Raichu</label>
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-3">
<label for="pokemon-tabs-pikachu-tab-3">Mega Raichu X</label>
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-4">
<label for="pokemon-tabs-pikachu-tab-4">Mega Raichu Y</label>
<input type="radio" name="pokemon-tabs-pikachu-group" id="pokemon-tabs-pikachu-tab-5">
...
<style>
#pokemon-tabs-pikachu-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-pikachu-panel-0 { display: block; }
#pokemon-tabs-pikachu-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-pikachu-panel-1 { display: block; }
#pokemon-tabs-pikachu-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-pikachu-panel-2 { display: block; }
#pokemon-tabs-pikachu-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-pikachu-panel-3 { display: block; }

<div class="pokemon-tabs" id="pokemon-tabs-clauncher-692">
<input type="radio" name="pokemon-tabs-clauncher-692-group" id="pokemon-tabs-clauncher-692-tab-0" checked>
<label for="pokemon-tabs-clauncher-692-tab-0">Clauncher</label>
<input type="radio" name="pokemon-tabs-clauncher-692-group" id="pokemon-tabs-clauncher-692-tab-1">
<label for="pokemon-tabs-clauncher-692-tab-1">Clawitzer</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-clauncher-692-panel-0">
## Clauncher (#692)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-clauncher-692-panel-1">
## Clawitzer (#693)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-clauncher-692-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-clauncher-692-panel-0 { display: block; }
#pokemon-tabs-clauncher-692-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-clauncher-692-panel-1 { display: block; }
</style>

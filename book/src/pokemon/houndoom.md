...
<input type="radio" name="pokemon-tabs-houndoom-group" id="pokemon-tabs-houndoom-tab-1" checked>
<label for="pokemon-tabs-houndoom-tab-1">Houndoom</label>
<input type="radio" name="pokemon-tabs-houndoom-group" id="pokemon-tabs-houndoom-tab-2">
...
<style>
#pokemon-tabs-houndoom-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-houndoom-panel-0 { display: block; }

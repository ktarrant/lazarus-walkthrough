...
<input type="radio" name="pokemon-tabs-chikorita-group" id="pokemon-tabs-chikorita-tab-1">
<label for="pokemon-tabs-chikorita-tab-1">Bayleef</label>
<input type="radio" name="pokemon-tabs-chikorita-group" id="pokemon-tabs-chikorita-tab-2">
...
<style>
#pokemon-tabs-chikorita-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-chikorita-panel-0 { display: block; }

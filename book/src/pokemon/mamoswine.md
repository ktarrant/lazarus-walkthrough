...
<input type="radio" name="pokemon-tabs-mamoswine-group" id="pokemon-tabs-mamoswine-tab-1">
<label for="pokemon-tabs-mamoswine-tab-1">Piloswine</label>
<input type="radio" name="pokemon-tabs-mamoswine-group" id="pokemon-tabs-mamoswine-tab-2" checked>
...
<style>
#pokemon-tabs-mamoswine-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mamoswine-panel-0 { display: block; }

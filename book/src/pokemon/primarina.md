...
<label for="pokemon-tabs-primarina-tab-0">Popplio</label>
<input type="radio" name="pokemon-tabs-primarina-group" id="pokemon-tabs-primarina-tab-1">
<label for="pokemon-tabs-primarina-tab-1">Brionne</label>
<input type="radio" name="pokemon-tabs-primarina-group" id="pokemon-tabs-primarina-tab-2" checked>
<label for="pokemon-tabs-primarina-tab-2">Primarina</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-primarina-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="popplio" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-primarina-panel-1">
Types: Water • Egg Groups: Water 1 / Field
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="brionne" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-primarina-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="primarina" /> Caught</label>
...
<style>
#pokemon-tabs-primarina-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-primarina-panel-0 { display: block; }
#pokemon-tabs-primarina-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-primarina-panel-1 { display: block; }
#pokemon-tabs-primarina-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-primarina-panel-2 { display: block; }
</style>
</details>

...
<summary>Lampent (#300)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-lampent">
<input type="radio" name="pokemon-tabs-lampent-group" id="pokemon-tabs-lampent-tab-0">
<label for="pokemon-tabs-lampent-tab-0">Litwick</label>
<input type="radio" name="pokemon-tabs-lampent-group" id="pokemon-tabs-lampent-tab-1" checked>
<label for="pokemon-tabs-lampent-tab-1">Lampent</label>
<input type="radio" name="pokemon-tabs-lampent-group" id="pokemon-tabs-lampent-tab-2">
...
<style>
#pokemon-tabs-lampent-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-lampent-panel-0 { display: block; }
#pokemon-tabs-lampent-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-lampent-panel-1 { display: block; }
#pokemon-tabs-lampent-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-lampent-panel-2 { display: block; }
</style>
</details>

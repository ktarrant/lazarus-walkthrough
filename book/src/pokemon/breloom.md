...
<input type="radio" name="pokemon-tabs-breloom-group" id="pokemon-tabs-breloom-tab-1" checked>
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="shroomish" /> Caught</label>
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="breloom" /> Caught</label>

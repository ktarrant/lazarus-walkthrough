...
<input type="radio" name="pokemon-tabs-fennekin-group" id="pokemon-tabs-fennekin-tab-1">
<label for="pokemon-tabs-fennekin-tab-1">Braixen</label>
<input type="radio" name="pokemon-tabs-fennekin-group" id="pokemon-tabs-fennekin-tab-2">
<label for="pokemon-tabs-fennekin-tab-2">Delphox</label>
<input type="radio" name="pokemon-tabs-fennekin-group" id="pokemon-tabs-fennekin-tab-3">
...
<style>
#pokemon-tabs-fennekin-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-fennekin-panel-0 { display: block; }
#pokemon-tabs-fennekin-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-fennekin-panel-1 { display: block; }

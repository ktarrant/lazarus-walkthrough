...
<input type="radio" name="pokemon-tabs-doublade-group" id="pokemon-tabs-doublade-tab-1" checked>
<label for="pokemon-tabs-doublade-tab-1">Doublade</label>
<input type="radio" name="pokemon-tabs-doublade-group" id="pokemon-tabs-doublade-tab-2">
...
<style>
#pokemon-tabs-doublade-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-doublade-panel-0 { display: block; }

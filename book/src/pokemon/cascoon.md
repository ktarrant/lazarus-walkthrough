<div class="pokemon-tabs" id="pokemon-tabs-cascoon-268">
<input type="radio" name="pokemon-tabs-cascoon-268-group" id="pokemon-tabs-cascoon-268-tab-0">
<label for="pokemon-tabs-cascoon-268-tab-0">Wurmple</label>
<input type="radio" name="pokemon-tabs-cascoon-268-group" id="pokemon-tabs-cascoon-268-tab-1">
<label for="pokemon-tabs-cascoon-268-tab-1">Silcoon</label>
<input type="radio" name="pokemon-tabs-cascoon-268-group" id="pokemon-tabs-cascoon-268-tab-2">
<label for="pokemon-tabs-cascoon-268-tab-2">Beautifly</label>
<input type="radio" name="pokemon-tabs-cascoon-268-group" id="pokemon-tabs-cascoon-268-tab-3" checked>
<label for="pokemon-tabs-cascoon-268-tab-3">Cascoon</label>
<input type="radio" name="pokemon-tabs-cascoon-268-group" id="pokemon-tabs-cascoon-268-tab-4">
<label for="pokemon-tabs-cascoon-268-tab-4">Dustox</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-cascoon-268-panel-0">
## Wurmple (#265)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-cascoon-268-panel-1">
## Silcoon (#266)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-cascoon-268-panel-2">
## Beautifly (#267)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-cascoon-268-panel-3">
## Cascoon (#268)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-cascoon-268-panel-4">
## Dustox (#269)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-cascoon-268-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-cascoon-268-panel-0 { display: block; }
#pokemon-tabs-cascoon-268-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-cascoon-268-panel-1 { display: block; }
#pokemon-tabs-cascoon-268-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-cascoon-268-panel-2 { display: block; }
#pokemon-tabs-cascoon-268-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-cascoon-268-panel-3 { display: block; }
#pokemon-tabs-cascoon-268-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-cascoon-268-panel-4 { display: block; }
</style>

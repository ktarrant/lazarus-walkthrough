...
<label for="pokemon-tabs-tinkaton-tab-0">Tinkatink</label>
<input type="radio" name="pokemon-tabs-tinkaton-group" id="pokemon-tabs-tinkaton-tab-1">
<label for="pokemon-tabs-tinkaton-tab-1">Tinkatuff</label>
<input type="radio" name="pokemon-tabs-tinkaton-group" id="pokemon-tabs-tinkaton-tab-2" checked>
<label for="pokemon-tabs-tinkaton-tab-2">Tinkaton</label>
<input type="radio" name="pokemon-tabs-tinkaton-group" id="pokemon-tabs-tinkaton-tab-3">
<label for="pokemon-tabs-tinkaton-tab-3">Mega Tinkaton</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-tinkaton-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-tinkaton-panel-1">
Types: Fairy / Steel • Egg Groups: Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-tinkaton-panel-2">
Types: Fairy / Steel • Egg Groups: Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-tinkaton-panel-3">
Types: Fairy / Steel • Egg Groups: Fairy
...
<style>
#pokemon-tabs-tinkaton-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-tinkaton-panel-0 { display: block; }
#pokemon-tabs-tinkaton-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-tinkaton-panel-1 { display: block; }
#pokemon-tabs-tinkaton-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-tinkaton-panel-2 { display: block; }
#pokemon-tabs-tinkaton-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-tinkaton-panel-3 { display: block; }
</style>
</details>

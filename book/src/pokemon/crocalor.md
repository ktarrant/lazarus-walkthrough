...
<input type="radio" name="pokemon-tabs-crocalor-group" id="pokemon-tabs-crocalor-tab-1" checked>
<label for="pokemon-tabs-crocalor-tab-1">Crocalor</label>
<input type="radio" name="pokemon-tabs-crocalor-group" id="pokemon-tabs-crocalor-tab-2">
...
<style>
#pokemon-tabs-crocalor-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-crocalor-panel-0 { display: block; }

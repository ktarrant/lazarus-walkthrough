...
<input type="radio" name="pokemon-tabs-braviary-group" id="pokemon-tabs-braviary-tab-1" checked>
<label for="pokemon-tabs-braviary-tab-1">Braviary</label>
<input type="radio" name="pokemon-tabs-braviary-group" id="pokemon-tabs-braviary-tab-2">
...
<style>
#pokemon-tabs-braviary-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-braviary-panel-0 { display: block; }

...
<label for="pokemon-tabs-alolan-raichu-tab-0">Pichu</label>
<input type="radio" name="pokemon-tabs-alolan-raichu-group" id="pokemon-tabs-alolan-raichu-tab-1">
<label for="pokemon-tabs-alolan-raichu-tab-1">Pikachu</label>
<input type="radio" name="pokemon-tabs-alolan-raichu-group" id="pokemon-tabs-alolan-raichu-tab-2">
<label for="pokemon-tabs-alolan-raichu-tab-2">Raichu</label>
<input type="radio" name="pokemon-tabs-alolan-raichu-group" id="pokemon-tabs-alolan-raichu-tab-3">
<label for="pokemon-tabs-alolan-raichu-tab-3">Mega Raichu X</label>
<input type="radio" name="pokemon-tabs-alolan-raichu-group" id="pokemon-tabs-alolan-raichu-tab-4">
<label for="pokemon-tabs-alolan-raichu-tab-4">Mega Raichu Y</label>
<input type="radio" name="pokemon-tabs-alolan-raichu-group" id="pokemon-tabs-alolan-raichu-tab-5" checked>
<label for="pokemon-tabs-alolan-raichu-tab-5">Alolan Raichu</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-raichu-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-raichu-panel-1">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-raichu-panel-2">
Types: Electric • Egg Groups: Field / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-raichu-panel-3">
Types: Electric • Egg Groups: Field / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-raichu-panel-4">
Types: Electric • Egg Groups: Field / Fairy
...
<div class="pokemon-tab-panel" id="pokemon-tabs-alolan-raichu-panel-5">
...
<style>
#pokemon-tabs-alolan-raichu-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-raichu-panel-0 { display: block; }
#pokemon-tabs-alolan-raichu-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-raichu-panel-1 { display: block; }
#pokemon-tabs-alolan-raichu-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-raichu-panel-2 { display: block; }
#pokemon-tabs-alolan-raichu-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-raichu-panel-3 { display: block; }
#pokemon-tabs-alolan-raichu-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-raichu-panel-4 { display: block; }
#pokemon-tabs-alolan-raichu-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-alolan-raichu-panel-5 { display: block; }
</style>
</details>

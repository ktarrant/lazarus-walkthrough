...
<input type="radio" name="pokemon-tabs-floragato-group" id="pokemon-tabs-floragato-tab-1" checked>
<label for="pokemon-tabs-floragato-tab-1">Floragato</label>
<input type="radio" name="pokemon-tabs-floragato-group" id="pokemon-tabs-floragato-tab-2">
...
<style>
#pokemon-tabs-floragato-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-floragato-panel-0 { display: block; }

...
<label for="pokemon-tabs-kirlia-tab-0">Ralts</label>
<input type="radio" name="pokemon-tabs-kirlia-group" id="pokemon-tabs-kirlia-tab-1" checked>
<label for="pokemon-tabs-kirlia-tab-1">Kirlia</label>
...
<input type="radio" name="pokemon-tabs-kirlia-group" id="pokemon-tabs-kirlia-tab-3">
<label for="pokemon-tabs-kirlia-tab-3">Mega Gardevoir</label>
<input type="radio" name="pokemon-tabs-kirlia-group" id="pokemon-tabs-kirlia-tab-4">
<label for="pokemon-tabs-kirlia-tab-4">Gallade</label>
<input type="radio" name="pokemon-tabs-kirlia-group" id="pokemon-tabs-kirlia-tab-5">
<label for="pokemon-tabs-kirlia-tab-5">Mega Gallade</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-kirlia-panel-3">
Types: Psychic / Fairy • Egg Groups: Human-Like / Amorphous
...
<div class="pokemon-tab-panel" id="pokemon-tabs-kirlia-panel-4">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-kirlia-panel-5">
Types: Psychic / Fighting • Egg Groups: Human-Like / Amorphous
...
#pokemon-tabs-kirlia-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-kirlia-panel-3 { display: block; }
#pokemon-tabs-kirlia-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-kirlia-panel-4 { display: block; }
#pokemon-tabs-kirlia-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-kirlia-panel-5 { display: block; }
</style>
</details>

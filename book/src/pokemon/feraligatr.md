...
<input type="radio" name="pokemon-tabs-feraligatr-group" id="pokemon-tabs-feraligatr-tab-1">
<label for="pokemon-tabs-feraligatr-tab-1">Croconaw</label>
<input type="radio" name="pokemon-tabs-feraligatr-group" id="pokemon-tabs-feraligatr-tab-2" checked>
...
<style>
#pokemon-tabs-feraligatr-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-feraligatr-panel-0 { display: block; }

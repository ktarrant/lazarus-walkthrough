...
<input type="radio" name="pokemon-tabs-haunter-group" id="pokemon-tabs-haunter-tab-1" checked>
<label for="pokemon-tabs-haunter-tab-1">Haunter</label>
<input type="radio" name="pokemon-tabs-haunter-group" id="pokemon-tabs-haunter-tab-2">
<label for="pokemon-tabs-haunter-tab-2">Gengar</label>
<input type="radio" name="pokemon-tabs-haunter-group" id="pokemon-tabs-haunter-tab-3">
...
<style>
#pokemon-tabs-haunter-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-haunter-panel-0 { display: block; }
#pokemon-tabs-haunter-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-haunter-panel-1 { display: block; }

<div class="pokemon-tabs" id="pokemon-tabs-clodsire-980">
<input type="radio" name="pokemon-tabs-clodsire-980-group" id="pokemon-tabs-clodsire-980-tab-0">
<label for="pokemon-tabs-clodsire-980-tab-0">Wooper</label>
<input type="radio" name="pokemon-tabs-clodsire-980-group" id="pokemon-tabs-clodsire-980-tab-1">
<label for="pokemon-tabs-clodsire-980-tab-1">Quagsire</label>
<input type="radio" name="pokemon-tabs-clodsire-980-group" id="pokemon-tabs-clodsire-980-tab-2" checked>
<label for="pokemon-tabs-clodsire-980-tab-2">Clodsire</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-clodsire-980-panel-0">
## Wooper (#194)
<details class="pokemon-card-container" open>
<summary>Wooper overview</summary>
_Water Fish Pokémon_ • Types: Water / Ground • Egg Groups: Water1 / Ground • Base EXP: 42
...
<div class="pokemon-tab-panel" id="pokemon-tabs-clodsire-980-panel-1">
## Quagsire (#195)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-clodsire-980-panel-2">
## Clodsire (#980)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-clodsire-980-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-clodsire-980-panel-0 { display: block; }
#pokemon-tabs-clodsire-980-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-clodsire-980-panel-1 { display: block; }
#pokemon-tabs-clodsire-980-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-clodsire-980-panel-2 { display: block; }
</style>

...
<summary>Hisuian Decidueye (#003)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-hisuian-decidueye">
<input type="radio" name="pokemon-tabs-hisuian-decidueye-group" id="pokemon-tabs-hisuian-decidueye-tab-0">
<label for="pokemon-tabs-hisuian-decidueye-tab-0">Rowlet</label>
<input type="radio" name="pokemon-tabs-hisuian-decidueye-group" id="pokemon-tabs-hisuian-decidueye-tab-1">
<label for="pokemon-tabs-hisuian-decidueye-tab-1">Dartrix</label>
<input type="radio" name="pokemon-tabs-hisuian-decidueye-group" id="pokemon-tabs-hisuian-decidueye-tab-2" checked>
<label for="pokemon-tabs-hisuian-decidueye-tab-2">Hisuian Decidueye</label>
<input type="radio" name="pokemon-tabs-hisuian-decidueye-group" id="pokemon-tabs-hisuian-decidueye-tab-3">
<label for="pokemon-tabs-hisuian-decidueye-tab-3">Decidueye</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-decidueye-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-decidueye-panel-1">
Types: Grass / Flying • Egg Groups: Flying
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-decidueye-panel-2">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-decidueye-panel-3">
...
<style>
#pokemon-tabs-hisuian-decidueye-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-decidueye-panel-0 { display: block; }
#pokemon-tabs-hisuian-decidueye-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-decidueye-panel-1 { display: block; }
#pokemon-tabs-hisuian-decidueye-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-decidueye-panel-2 { display: block; }
#pokemon-tabs-hisuian-decidueye-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-decidueye-panel-3 { display: block; }
</style>
</details>

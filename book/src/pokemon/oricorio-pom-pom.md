...
<input type="radio" name="pokemon-tabs-oricorio-pom-pom-group" id="pokemon-tabs-oricorio-pom-pom-tab-1" checked>
<label for="pokemon-tabs-oricorio-pom-pom-tab-1">Oricorio Pom-Pom</label>
<input type="radio" name="pokemon-tabs-oricorio-pom-pom-group" id="pokemon-tabs-oricorio-pom-pom-tab-2">
<label for="pokemon-tabs-oricorio-pom-pom-tab-2">Oricorio Pa'u</label>
<input type="radio" name="pokemon-tabs-oricorio-pom-pom-group" id="pokemon-tabs-oricorio-pom-pom-tab-3">
...
<style>
#pokemon-tabs-oricorio-pom-pom-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-oricorio-pom-pom-panel-0 { display: block; }
#pokemon-tabs-oricorio-pom-pom-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-oricorio-pom-pom-panel-1 { display: block; }

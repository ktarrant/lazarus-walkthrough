...
<label for="pokemon-tabs-magnemite-tab-0">Magnemite</label>
<input type="radio" name="pokemon-tabs-magnemite-group" id="pokemon-tabs-magnemite-tab-1">
<label for="pokemon-tabs-magnemite-tab-1">Magneton</label>
<input type="radio" name="pokemon-tabs-magnemite-group" id="pokemon-tabs-magnemite-tab-2">
...
<style>
#pokemon-tabs-magnemite-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-magnemite-panel-0 { display: block; }
#pokemon-tabs-magnemite-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-magnemite-panel-1 { display: block; }
#pokemon-tabs-magnemite-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-magnemite-panel-2 { display: block; }
</style>

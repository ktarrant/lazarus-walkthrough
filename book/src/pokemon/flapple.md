...
<label for="pokemon-tabs-flapple-tab-0">Applin</label>
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-1" checked>
<label for="pokemon-tabs-flapple-tab-1">Flapple</label>
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-2">
<label for="pokemon-tabs-flapple-tab-2">Appletun</label>
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-3">
<label for="pokemon-tabs-flapple-tab-3">Dipplin</label>
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-4">
<label for="pokemon-tabs-flapple-tab-4">Hydrapple</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-flapple-panel-0">
## Applin (#064)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flapple-panel-1">
## Flapple (#065)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flapple-panel-2">
## Appletun (#066)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flapple-panel-3">
## Dipplin (#067)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-flapple-panel-4">
## Hydrapple (#068)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-flapple-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-flapple-panel-0 { display: block; }
#pokemon-tabs-flapple-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-flapple-panel-1 { display: block; }
#pokemon-tabs-flapple-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-flapple-panel-2 { display: block; }
#pokemon-tabs-flapple-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-flapple-panel-3 { display: block; }
#pokemon-tabs-flapple-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-flapple-panel-4 { display: block; }
</style>

...
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-1">
<label for="pokemon-tabs-flapple-tab-1">Appletun</label>
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-2">
<label for="pokemon-tabs-flapple-tab-2">Dipplin</label>
<input type="radio" name="pokemon-tabs-flapple-group" id="pokemon-tabs-flapple-tab-3" checked>
<label for="pokemon-tabs-flapple-tab-3">Flapple</label>

<div class="pokemon-tabs" id="pokemon-tabs-primeape-57">
<input type="radio" name="pokemon-tabs-primeape-57-group" id="pokemon-tabs-primeape-57-tab-0">
<label for="pokemon-tabs-primeape-57-tab-0">Mankey</label>
<input type="radio" name="pokemon-tabs-primeape-57-group" id="pokemon-tabs-primeape-57-tab-1" checked>
<label for="pokemon-tabs-primeape-57-tab-1">Primeape</label>
<input type="radio" name="pokemon-tabs-primeape-57-group" id="pokemon-tabs-primeape-57-tab-2">
<label for="pokemon-tabs-primeape-57-tab-2">Annihilape</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-primeape-57-panel-0">
## Mankey (#056)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-primeape-57-panel-1">
## Primeape (#057)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-primeape-57-panel-2">
## Annihilape (#979)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-primeape-57-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-primeape-57-panel-0 { display: block; }
#pokemon-tabs-primeape-57-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-primeape-57-panel-1 { display: block; }
#pokemon-tabs-primeape-57-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-primeape-57-panel-2 { display: block; }
</style>

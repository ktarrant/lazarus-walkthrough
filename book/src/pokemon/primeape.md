...
<input type="radio" name="pokemon-tabs-primeape-group" id="pokemon-tabs-primeape-tab-0" checked>
<label for="pokemon-tabs-primeape-tab-0">Primeape</label>
<input type="radio" name="pokemon-tabs-primeape-group" id="pokemon-tabs-primeape-tab-1">
<label for="pokemon-tabs-primeape-tab-1">Annihilape</label>

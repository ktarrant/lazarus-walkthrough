...
<input type="radio" name="pokemon-tabs-vibrava-group" id="pokemon-tabs-vibrava-tab-1" checked>
<label for="pokemon-tabs-vibrava-tab-1">Vibrava</label>
<input type="radio" name="pokemon-tabs-vibrava-group" id="pokemon-tabs-vibrava-tab-2">
<label for="pokemon-tabs-vibrava-tab-2">Flygon</label>
<input type="radio" name="pokemon-tabs-vibrava-group" id="pokemon-tabs-vibrava-tab-3">
...
<style>
#pokemon-tabs-vibrava-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-vibrava-panel-0 { display: block; }
#pokemon-tabs-vibrava-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-vibrava-panel-1 { display: block; }

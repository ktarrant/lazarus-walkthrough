...
<label for="pokemon-tabs-froakie-tab-0">Froakie</label>
<input type="radio" name="pokemon-tabs-froakie-group" id="pokemon-tabs-froakie-tab-1">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-froakie-panel-1">
Types: Water • Egg Groups: Water 1
...
<div class="pokemon-tab-panel" id="pokemon-tabs-froakie-panel-2">

<div class="pokemon-tabs" id="pokemon-tabs-bellsprout-69">
<input type="radio" name="pokemon-tabs-bellsprout-69-group" id="pokemon-tabs-bellsprout-69-tab-0" checked>
<label for="pokemon-tabs-bellsprout-69-tab-0">Bellsprout</label>
<input type="radio" name="pokemon-tabs-bellsprout-69-group" id="pokemon-tabs-bellsprout-69-tab-1">
<label for="pokemon-tabs-bellsprout-69-tab-1">Weepinbell</label>
<input type="radio" name="pokemon-tabs-bellsprout-69-group" id="pokemon-tabs-bellsprout-69-tab-2">
<label for="pokemon-tabs-bellsprout-69-tab-2">Victreebel</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-bellsprout-69-panel-0">
## Bellsprout (#069)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-bellsprout-69-panel-1">
## Weepinbell (#070)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-bellsprout-69-panel-2">
## Victreebel (#071)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-bellsprout-69-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-bellsprout-69-panel-0 { display: block; }
#pokemon-tabs-bellsprout-69-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-bellsprout-69-panel-1 { display: block; }
#pokemon-tabs-bellsprout-69-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-bellsprout-69-panel-2 { display: block; }
</style>

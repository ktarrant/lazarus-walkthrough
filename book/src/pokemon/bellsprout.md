...
<input type="radio" name="pokemon-tabs-bellsprout-group" id="pokemon-tabs-bellsprout-tab-1">
<label for="pokemon-tabs-bellsprout-tab-1">Weepinbell</label>
<input type="radio" name="pokemon-tabs-bellsprout-group" id="pokemon-tabs-bellsprout-tab-2">
<label for="pokemon-tabs-bellsprout-tab-2">Victreebel</label>
<input type="radio" name="pokemon-tabs-bellsprout-group" id="pokemon-tabs-bellsprout-tab-3">
...
<style>
#pokemon-tabs-bellsprout-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-bellsprout-panel-0 { display: block; }
#pokemon-tabs-bellsprout-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-bellsprout-panel-1 { display: block; }

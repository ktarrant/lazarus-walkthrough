...
<input type="radio" name="pokemon-tabs-armarouge-group" id="pokemon-tabs-armarouge-tab-1" checked>
<label for="pokemon-tabs-armarouge-tab-1">Armarouge</label>
<input type="radio" name="pokemon-tabs-armarouge-group" id="pokemon-tabs-armarouge-tab-2">
...
<style>
#pokemon-tabs-armarouge-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-armarouge-panel-0 { display: block; }

...
<label for="pokemon-tabs-tentacool-tab-0">Tentacool</label>
<input type="radio" name="pokemon-tabs-tentacool-group" id="pokemon-tabs-tentacool-tab-1">
<label for="pokemon-tabs-tentacool-tab-1">Tentacruel</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-tentacool-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="tentacool" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-tentacool-panel-1">
Types: Water / Poison • Egg Groups: Water 3
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="tentacruel" /> Caught</label>
...
<style>
#pokemon-tabs-tentacool-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-tentacool-panel-0 { display: block; }
#pokemon-tabs-tentacool-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-tentacool-panel-1 { display: block; }
</style>
</details>

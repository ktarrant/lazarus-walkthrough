...
<input type="radio" name="pokemon-tabs-helioptile-group" id="pokemon-tabs-helioptile-tab-1" checked>
<label for="pokemon-tabs-helioptile-tab-1">Helioptile</label>
<input type="radio" name="pokemon-tabs-helioptile-group" id="pokemon-tabs-helioptile-tab-2">
...
<style>
#pokemon-tabs-helioptile-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-helioptile-panel-0 { display: block; }

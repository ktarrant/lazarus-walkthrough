...
<input type="radio" name="pokemon-tabs-stoutland-group" id="pokemon-tabs-stoutland-tab-1">
<label for="pokemon-tabs-stoutland-tab-1">Herdier</label>
<input type="radio" name="pokemon-tabs-stoutland-group" id="pokemon-tabs-stoutland-tab-2" checked>
...
<style>
#pokemon-tabs-stoutland-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-stoutland-panel-0 { display: block; }

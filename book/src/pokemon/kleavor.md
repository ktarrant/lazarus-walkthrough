...
<summary>Kleavor (#266)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-kleavor">
<input type="radio" name="pokemon-tabs-kleavor-group" id="pokemon-tabs-kleavor-tab-0">
<label for="pokemon-tabs-kleavor-tab-0">Scyther</label>
<input type="radio" name="pokemon-tabs-kleavor-group" id="pokemon-tabs-kleavor-tab-1">
<label for="pokemon-tabs-kleavor-tab-1">Scizor</label>
<input type="radio" name="pokemon-tabs-kleavor-group" id="pokemon-tabs-kleavor-tab-2">
<label for="pokemon-tabs-kleavor-tab-2">Mega Scizor</label>
<input type="radio" name="pokemon-tabs-kleavor-group" id="pokemon-tabs-kleavor-tab-3" checked>
<label for="pokemon-tabs-kleavor-tab-3">Kleavor</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-kleavor-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="scyther" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-kleavor-panel-1">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="scizor" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-kleavor-panel-2">
Types: Bug / Steel • Egg Groups: Bug
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="mega-scizor" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-kleavor-panel-3">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="kleavor" /> Caught</label>
...
<style>
#pokemon-tabs-kleavor-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-kleavor-panel-0 { display: block; }
#pokemon-tabs-kleavor-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-kleavor-panel-1 { display: block; }
#pokemon-tabs-kleavor-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-kleavor-panel-2 { display: block; }
#pokemon-tabs-kleavor-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-kleavor-panel-3 { display: block; }
</style>
</details>

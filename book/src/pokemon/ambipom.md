...
<label for="pokemon-tabs-ambipom-tab-0">Aipom</label>
<input type="radio" name="pokemon-tabs-ambipom-group" id="pokemon-tabs-ambipom-tab-1" checked>
<label for="pokemon-tabs-ambipom-tab-1">Ambipom</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-ambipom-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="aipom" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-ambipom-panel-1">
Types: Normal • Egg Groups: Field
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="ambipom" /> Caught</label>
...
<style>
#pokemon-tabs-ambipom-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-ambipom-panel-0 { display: block; }
#pokemon-tabs-ambipom-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-ambipom-panel-1 { display: block; }
</style>
</details>

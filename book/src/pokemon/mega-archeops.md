...
<input type="radio" name="pokemon-tabs-mega-archeops-group" id="pokemon-tabs-mega-archeops-tab-1">
<label for="pokemon-tabs-mega-archeops-tab-1">Archeops</label>
<input type="radio" name="pokemon-tabs-mega-archeops-group" id="pokemon-tabs-mega-archeops-tab-2" checked>
...
<style>
#pokemon-tabs-mega-archeops-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-archeops-panel-0 { display: block; }

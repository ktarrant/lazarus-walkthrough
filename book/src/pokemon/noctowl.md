...
<label for="pokemon-tabs-noctowl-tab-0">Hoothoot</label>
<input type="radio" name="pokemon-tabs-noctowl-group" id="pokemon-tabs-noctowl-tab-1" checked>
<label for="pokemon-tabs-noctowl-tab-1">Noctowl</label>
<input type="radio" name="pokemon-tabs-noctowl-group" id="pokemon-tabs-noctowl-tab-2">
<label for="pokemon-tabs-noctowl-tab-2">Mega Noctowl</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-noctowl-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-noctowl-panel-1">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-noctowl-panel-2">
Types: Ghost / Flying • Egg Groups: Flying
...
<style>
#pokemon-tabs-noctowl-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-noctowl-panel-0 { display: block; }
#pokemon-tabs-noctowl-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-noctowl-panel-1 { display: block; }
#pokemon-tabs-noctowl-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-noctowl-panel-2 { display: block; }
</style>
</details>

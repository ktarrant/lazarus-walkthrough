...
<input type="radio" name="pokemon-tabs-gothorita-group" id="pokemon-tabs-gothorita-tab-1" checked>
<label for="pokemon-tabs-gothorita-tab-1">Gothorita</label>
<input type="radio" name="pokemon-tabs-gothorita-group" id="pokemon-tabs-gothorita-tab-2">
...
<style>
#pokemon-tabs-gothorita-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-gothorita-panel-0 { display: block; }

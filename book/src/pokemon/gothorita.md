<div class="pokemon-tabs" id="pokemon-tabs-gothorita-575">
<input type="radio" name="pokemon-tabs-gothorita-575-group" id="pokemon-tabs-gothorita-575-tab-0">
<label for="pokemon-tabs-gothorita-575-tab-0">Gothita</label>
<input type="radio" name="pokemon-tabs-gothorita-575-group" id="pokemon-tabs-gothorita-575-tab-1" checked>
<label for="pokemon-tabs-gothorita-575-tab-1">Gothorita</label>
<input type="radio" name="pokemon-tabs-gothorita-575-group" id="pokemon-tabs-gothorita-575-tab-2">
<label for="pokemon-tabs-gothorita-575-tab-2">Gothitelle</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-gothorita-575-panel-0">
## Gothita (#574)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gothorita-575-panel-1">
## Gothorita (#575)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gothorita-575-panel-2">
## Gothitelle (#576)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-gothorita-575-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-gothorita-575-panel-0 { display: block; }
#pokemon-tabs-gothorita-575-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-gothorita-575-panel-1 { display: block; }
#pokemon-tabs-gothorita-575-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-gothorita-575-panel-2 { display: block; }
</style>

...
<summary>Scizor (#265)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-scizor">
<input type="radio" name="pokemon-tabs-scizor-group" id="pokemon-tabs-scizor-tab-0">
<label for="pokemon-tabs-scizor-tab-0">Scyther</label>
<input type="radio" name="pokemon-tabs-scizor-group" id="pokemon-tabs-scizor-tab-1" checked>
<label for="pokemon-tabs-scizor-tab-1">Scizor</label>
<input type="radio" name="pokemon-tabs-scizor-group" id="pokemon-tabs-scizor-tab-2">
<label for="pokemon-tabs-scizor-tab-2">Mega Scizor</label>
<input type="radio" name="pokemon-tabs-scizor-group" id="pokemon-tabs-scizor-tab-3">
<label for="pokemon-tabs-scizor-tab-3">Kleavor</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-scizor-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-scizor-panel-1">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-scizor-panel-2">
Types: Bug / Steel • Egg Groups: Bug
...
<div class="pokemon-tab-panel" id="pokemon-tabs-scizor-panel-3">
...
<style>
#pokemon-tabs-scizor-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-scizor-panel-0 { display: block; }
#pokemon-tabs-scizor-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-scizor-panel-1 { display: block; }
#pokemon-tabs-scizor-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-scizor-panel-2 { display: block; }
#pokemon-tabs-scizor-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-scizor-panel-3 { display: block; }
</style>
</details>

...
<label for="pokemon-tabs-torracat-tab-0">Litten</label>
<input type="radio" name="pokemon-tabs-torracat-group" id="pokemon-tabs-torracat-tab-1" checked>
<label for="pokemon-tabs-torracat-tab-1">Torracat</label>
<input type="radio" name="pokemon-tabs-torracat-group" id="pokemon-tabs-torracat-tab-2">
<label for="pokemon-tabs-torracat-tab-2">Incineroar</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-torracat-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-torracat-panel-1">
Types: Fire • Egg Groups: Field
...
<div class="pokemon-tab-panel" id="pokemon-tabs-torracat-panel-2">
...
<style>
#pokemon-tabs-torracat-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-torracat-panel-0 { display: block; }
#pokemon-tabs-torracat-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-torracat-panel-1 { display: block; }
#pokemon-tabs-torracat-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-torracat-panel-2 { display: block; }
</style>
</details>

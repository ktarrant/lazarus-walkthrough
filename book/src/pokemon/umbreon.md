...
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-1">
<label for="pokemon-tabs-umbreon-tab-1">Vaporeon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-2">
<label for="pokemon-tabs-umbreon-tab-2">Jolteon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-3">
<label for="pokemon-tabs-umbreon-tab-3">Flareon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-4">
<label for="pokemon-tabs-umbreon-tab-4">Espeon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-5" checked>
<label for="pokemon-tabs-umbreon-tab-5">Umbreon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-6">
<label for="pokemon-tabs-umbreon-tab-6">Leafeon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-7">
<label for="pokemon-tabs-umbreon-tab-7">Glaceon</label>
<input type="radio" name="pokemon-tabs-umbreon-group" id="pokemon-tabs-umbreon-tab-8">
...
<style>
#pokemon-tabs-umbreon-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-0 { display: block; }
#pokemon-tabs-umbreon-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-1 { display: block; }
#pokemon-tabs-umbreon-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-2 { display: block; }
#pokemon-tabs-umbreon-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-3 { display: block; }
#pokemon-tabs-umbreon-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-4 { display: block; }
#pokemon-tabs-umbreon-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-5 { display: block; }
#pokemon-tabs-umbreon-tab-6:checked ~ .pokemon-tab-panels #pokemon-tabs-umbreon-panel-6 { display: block; }

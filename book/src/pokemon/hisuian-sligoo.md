...
<input type="radio" name="pokemon-tabs-hisuian-sliggoo-group" id="pokemon-tabs-hisuian-sliggoo-tab-1">
<label for="pokemon-tabs-hisuian-sliggoo-tab-1">Sliggoo</label>
<input type="radio" name="pokemon-tabs-hisuian-sliggoo-group" id="pokemon-tabs-hisuian-sliggoo-tab-2">
<label for="pokemon-tabs-hisuian-sliggoo-tab-2">Goodra</label>
<input type="radio" name="pokemon-tabs-hisuian-sliggoo-group" id="pokemon-tabs-hisuian-sliggoo-tab-3" checked>
<label for="pokemon-tabs-hisuian-sliggoo-tab-3">Hisuian Sliggoo</label>
<input type="radio" name="pokemon-tabs-hisuian-sliggoo-group" id="pokemon-tabs-hisuian-sliggoo-tab-4">
...
<style>
#pokemon-tabs-hisuian-sliggoo-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-sliggoo-panel-0 { display: block; }
#pokemon-tabs-hisuian-sliggoo-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-sliggoo-panel-1 { display: block; }
#pokemon-tabs-hisuian-sliggoo-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-sliggoo-panel-2 { display: block; }

...
<input type="radio" name="pokemon-tabs-applin-group" id="pokemon-tabs-applin-tab-1">
<label for="pokemon-tabs-applin-tab-1">Flapple</label>
<input type="radio" name="pokemon-tabs-applin-group" id="pokemon-tabs-applin-tab-2">
<label for="pokemon-tabs-applin-tab-2">Appletun</label>
<input type="radio" name="pokemon-tabs-applin-group" id="pokemon-tabs-applin-tab-3">
<label for="pokemon-tabs-applin-tab-3">Dipplin</label>
<input type="radio" name="pokemon-tabs-applin-group" id="pokemon-tabs-applin-tab-4">
...
<style>
#pokemon-tabs-applin-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-panel-0 { display: block; }
#pokemon-tabs-applin-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-panel-1 { display: block; }
#pokemon-tabs-applin-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-panel-2 { display: block; }

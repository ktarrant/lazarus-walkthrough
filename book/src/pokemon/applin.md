<div class="pokemon-tabs" id="pokemon-tabs-applin-840">
<input type="radio" name="pokemon-tabs-applin-840-group" id="pokemon-tabs-applin-840-tab-0" checked>
<label for="pokemon-tabs-applin-840-tab-0">Applin</label>
<input type="radio" name="pokemon-tabs-applin-840-group" id="pokemon-tabs-applin-840-tab-1">
<label for="pokemon-tabs-applin-840-tab-1">Flapple</label>
<input type="radio" name="pokemon-tabs-applin-840-group" id="pokemon-tabs-applin-840-tab-2">
<label for="pokemon-tabs-applin-840-tab-2">Appletun</label>
<input type="radio" name="pokemon-tabs-applin-840-group" id="pokemon-tabs-applin-840-tab-3">
<label for="pokemon-tabs-applin-840-tab-3">Dipplin</label>
<input type="radio" name="pokemon-tabs-applin-840-group" id="pokemon-tabs-applin-840-tab-4">
<label for="pokemon-tabs-applin-840-tab-4">Hydrapple</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-applin-840-panel-0">
## Applin (#840)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-applin-840-panel-1">
## Flapple (#841)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-applin-840-panel-2">
## Appletun (#842)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-applin-840-panel-3">
## Dipplin (#1011)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-applin-840-panel-4">
## Hydrapple (#1019)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-applin-840-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-840-panel-0 { display: block; }
#pokemon-tabs-applin-840-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-840-panel-1 { display: block; }
#pokemon-tabs-applin-840-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-840-panel-2 { display: block; }
#pokemon-tabs-applin-840-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-840-panel-3 { display: block; }
#pokemon-tabs-applin-840-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-applin-840-panel-4 { display: block; }
</style>

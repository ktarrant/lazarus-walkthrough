...
<label for="pokemon-tabs-hisuian-braviary-tab-0">Rufflet</label>
<input type="radio" name="pokemon-tabs-hisuian-braviary-group" id="pokemon-tabs-hisuian-braviary-tab-1">
<label for="pokemon-tabs-hisuian-braviary-tab-1">Braviary</label>
<input type="radio" name="pokemon-tabs-hisuian-braviary-group" id="pokemon-tabs-hisuian-braviary-tab-2" checked>
<label for="pokemon-tabs-hisuian-braviary-tab-2">Hisuian Braviary</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-braviary-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="rufflet" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-braviary-panel-1">
Types: Normal / Flying • Egg Groups: Flying
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="braviary" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hisuian-braviary-panel-2">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="hisuian-braviary" /> Caught</label>
...
<style>
#pokemon-tabs-hisuian-braviary-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-braviary-panel-0 { display: block; }
#pokemon-tabs-hisuian-braviary-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-braviary-panel-1 { display: block; }
#pokemon-tabs-hisuian-braviary-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-hisuian-braviary-panel-2 { display: block; }
</style>
</details>

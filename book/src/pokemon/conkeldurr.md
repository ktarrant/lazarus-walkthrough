...
<input type="radio" name="pokemon-tabs-conkeldurr-group" id="pokemon-tabs-conkeldurr-tab-1">
<label for="pokemon-tabs-conkeldurr-tab-1">Gurdurr</label>
<input type="radio" name="pokemon-tabs-conkeldurr-group" id="pokemon-tabs-conkeldurr-tab-2" checked>
...
<style>
#pokemon-tabs-conkeldurr-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-conkeldurr-panel-0 { display: block; }

...
<input type="radio" name="pokemon-tabs-lycanroc-group" id="pokemon-tabs-lycanroc-tab-1" checked>
<label for="pokemon-tabs-lycanroc-tab-1">Lycanroc</label>
<input type="radio" name="pokemon-tabs-lycanroc-group" id="pokemon-tabs-lycanroc-tab-2">
<label for="pokemon-tabs-lycanroc-tab-2">Midnight Lycanroc</label>
<input type="radio" name="pokemon-tabs-lycanroc-group" id="pokemon-tabs-lycanroc-tab-3">
...
<style>
#pokemon-tabs-lycanroc-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-lycanroc-panel-0 { display: block; }
#pokemon-tabs-lycanroc-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-lycanroc-panel-1 { display: block; }

...
<label for="pokemon-tabs-honedge-tab-0">Honedge</label>
<input type="radio" name="pokemon-tabs-honedge-group" id="pokemon-tabs-honedge-tab-1">
<label for="pokemon-tabs-honedge-tab-1">Doublade</label>
<input type="radio" name="pokemon-tabs-honedge-group" id="pokemon-tabs-honedge-tab-2">
<label for="pokemon-tabs-honedge-tab-2">Aegislash</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-honedge-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-honedge-panel-1">
Types: Steel / Ghost • Egg Groups: Mineral
...
<div class="pokemon-tab-panel" id="pokemon-tabs-honedge-panel-2">
Types: Steel / Ghost • Egg Groups: Mineral
...
<style>
#pokemon-tabs-honedge-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-honedge-panel-0 { display: block; }
#pokemon-tabs-honedge-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-honedge-panel-1 { display: block; }
#pokemon-tabs-honedge-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-honedge-panel-2 { display: block; }
</style>
</details>

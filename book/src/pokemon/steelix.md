...
<input type="radio" name="pokemon-tabs-steelix-group" id="pokemon-tabs-steelix-tab-1" checked>
<label for="pokemon-tabs-steelix-tab-1">Steelix</label>
<input type="radio" name="pokemon-tabs-steelix-group" id="pokemon-tabs-steelix-tab-2">
...
<style>
#pokemon-tabs-steelix-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-steelix-panel-0 { display: block; }

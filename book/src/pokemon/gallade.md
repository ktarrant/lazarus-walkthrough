...
<summary>Gallade (#082)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-gallade">
<input type="radio" name="pokemon-tabs-gallade-group" id="pokemon-tabs-gallade-tab-0">
<label for="pokemon-tabs-gallade-tab-0">Ralts</label>
<input type="radio" name="pokemon-tabs-gallade-group" id="pokemon-tabs-gallade-tab-1">
<label for="pokemon-tabs-gallade-tab-1">Kirlia</label>
<input type="radio" name="pokemon-tabs-gallade-group" id="pokemon-tabs-gallade-tab-2">
<label for="pokemon-tabs-gallade-tab-2">Gardevoir</label>
<input type="radio" name="pokemon-tabs-gallade-group" id="pokemon-tabs-gallade-tab-3">
<label for="pokemon-tabs-gallade-tab-3">Mega Gardevoir</label>
<input type="radio" name="pokemon-tabs-gallade-group" id="pokemon-tabs-gallade-tab-4" checked>
<label for="pokemon-tabs-gallade-tab-4">Gallade</label>
<input type="radio" name="pokemon-tabs-gallade-group" id="pokemon-tabs-gallade-tab-5">
<label for="pokemon-tabs-gallade-tab-5">Mega Gallade</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-gallade-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gallade-panel-1">
Types: Psychic / Fairy • Egg Groups: Human-Like / Amorphous
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gallade-panel-2">
Types: Psychic / Fairy • Egg Groups: Human-Like / Amorphous
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gallade-panel-3">
Types: Psychic / Fairy • Egg Groups: Human-Like / Amorphous
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gallade-panel-4">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gallade-panel-5">
Types: Psychic / Fighting • Egg Groups: Human-Like / Amorphous
...
<style>
#pokemon-tabs-gallade-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-gallade-panel-0 { display: block; }
#pokemon-tabs-gallade-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-gallade-panel-1 { display: block; }
#pokemon-tabs-gallade-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-gallade-panel-2 { display: block; }
#pokemon-tabs-gallade-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-gallade-panel-3 { display: block; }
#pokemon-tabs-gallade-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-gallade-panel-4 { display: block; }
#pokemon-tabs-gallade-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-gallade-panel-5 { display: block; }
</style>
</details>

...
<input type="radio" name="pokemon-tabs-mega-tinkaton-group" id="pokemon-tabs-mega-tinkaton-tab-1">
<label for="pokemon-tabs-mega-tinkaton-tab-1">Tinkatuff</label>
<input type="radio" name="pokemon-tabs-mega-tinkaton-group" id="pokemon-tabs-mega-tinkaton-tab-2">
<label for="pokemon-tabs-mega-tinkaton-tab-2">Tinkaton</label>
<input type="radio" name="pokemon-tabs-mega-tinkaton-group" id="pokemon-tabs-mega-tinkaton-tab-3" checked>
...
<style>
#pokemon-tabs-mega-tinkaton-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-tinkaton-panel-0 { display: block; }
#pokemon-tabs-mega-tinkaton-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-tinkaton-panel-1 { display: block; }

<div class="pokemon-tabs" id="pokemon-tabs-annihilape-979">
<input type="radio" name="pokemon-tabs-annihilape-979-group" id="pokemon-tabs-annihilape-979-tab-0">
<label for="pokemon-tabs-annihilape-979-tab-0">Mankey</label>
<input type="radio" name="pokemon-tabs-annihilape-979-group" id="pokemon-tabs-annihilape-979-tab-1">
<label for="pokemon-tabs-annihilape-979-tab-1">Primeape</label>
<input type="radio" name="pokemon-tabs-annihilape-979-group" id="pokemon-tabs-annihilape-979-tab-2" checked>
<label for="pokemon-tabs-annihilape-979-tab-2">Annihilape</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-annihilape-979-panel-0">
## Mankey (#056)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-annihilape-979-panel-1">
## Primeape (#057)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-annihilape-979-panel-2">
## Annihilape (#979)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-annihilape-979-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-annihilape-979-panel-0 { display: block; }
#pokemon-tabs-annihilape-979-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-annihilape-979-panel-1 { display: block; }
#pokemon-tabs-annihilape-979-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-annihilape-979-panel-2 { display: block; }
</style>

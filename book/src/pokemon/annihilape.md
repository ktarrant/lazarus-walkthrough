...
<input type="radio" name="pokemon-tabs-annihilape-group" id="pokemon-tabs-annihilape-tab-1">
<label for="pokemon-tabs-annihilape-tab-1">Primeape</label>
<input type="radio" name="pokemon-tabs-annihilape-group" id="pokemon-tabs-annihilape-tab-2" checked>
...
<style>
#pokemon-tabs-annihilape-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-annihilape-panel-0 { display: block; }

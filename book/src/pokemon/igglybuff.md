...
<input type="radio" name="pokemon-tabs-igglybuff-group" id="pokemon-tabs-igglybuff-tab-1">
<label for="pokemon-tabs-igglybuff-tab-1">Jigglypuff</label>
<input type="radio" name="pokemon-tabs-igglybuff-group" id="pokemon-tabs-igglybuff-tab-2">
...
<style>
#pokemon-tabs-igglybuff-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-igglybuff-panel-0 { display: block; }

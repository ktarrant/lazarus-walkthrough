...
<label for="pokemon-tabs-charjabug-tab-0">Grubbin</label>
<input type="radio" name="pokemon-tabs-charjabug-group" id="pokemon-tabs-charjabug-tab-1" checked>
<label for="pokemon-tabs-charjabug-tab-1">Charjabug</label>
<input type="radio" name="pokemon-tabs-charjabug-group" id="pokemon-tabs-charjabug-tab-2">
<label for="pokemon-tabs-charjabug-tab-2">Vikavolt</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-charjabug-panel-2">
Types: Bug / Electric • Egg Groups: Bug
...
#pokemon-tabs-charjabug-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-charjabug-panel-2 { display: block; }
</style>
</details>

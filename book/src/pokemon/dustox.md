...
<input type="radio" name="pokemon-tabs-dustox-group" id="pokemon-tabs-dustox-tab-1">
<label for="pokemon-tabs-dustox-tab-1">Silcoon</label>
<input type="radio" name="pokemon-tabs-dustox-group" id="pokemon-tabs-dustox-tab-2">
<label for="pokemon-tabs-dustox-tab-2">Beautifly</label>
<input type="radio" name="pokemon-tabs-dustox-group" id="pokemon-tabs-dustox-tab-3">
<label for="pokemon-tabs-dustox-tab-3">Cascoon</label>
<input type="radio" name="pokemon-tabs-dustox-group" id="pokemon-tabs-dustox-tab-4" checked>
...
#pokemon-tabs-dustox-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-dustox-panel-2 { display: block; }

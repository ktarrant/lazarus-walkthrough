...
<input type="radio" name="pokemon-tabs-dreepy-group" id="pokemon-tabs-dreepy-tab-1">
<label for="pokemon-tabs-dreepy-tab-1">Drakloak</label>
<input type="radio" name="pokemon-tabs-dreepy-group" id="pokemon-tabs-dreepy-tab-2">
...
<style>
#pokemon-tabs-dreepy-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-dreepy-panel-0 { display: block; }

...
<label for="pokemon-tabs-hakamo-o-tab-0">Jangmo-o</label>
<input type="radio" name="pokemon-tabs-hakamo-o-group" id="pokemon-tabs-hakamo-o-tab-1" checked>
<label for="pokemon-tabs-hakamo-o-tab-1">Hakamo-o</label>
<input type="radio" name="pokemon-tabs-hakamo-o-group" id="pokemon-tabs-hakamo-o-tab-2">
<label for="pokemon-tabs-hakamo-o-tab-2">Kommo-o</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-hakamo-o-panel-0">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="jangmo-o" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hakamo-o-panel-1">
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="hakamo-o" /> Caught</label>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-hakamo-o-panel-2">
Types: Dragon / Fighting • Egg Groups: Dragon
...
<div class="card-column">
<label><input type="checkbox" class="caught-check" data-species="kommo-o" /> Caught</label>
...
<style>
#pokemon-tabs-hakamo-o-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-hakamo-o-panel-0 { display: block; }
#pokemon-tabs-hakamo-o-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-hakamo-o-panel-1 { display: block; }
#pokemon-tabs-hakamo-o-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-hakamo-o-panel-2 { display: block; }
</style>
</details>

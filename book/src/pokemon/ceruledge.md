<div class="pokemon-tabs" id="pokemon-tabs-ceruledge-937">
<input type="radio" name="pokemon-tabs-ceruledge-937-group" id="pokemon-tabs-ceruledge-937-tab-0">
<label for="pokemon-tabs-ceruledge-937-tab-0">Charcadet</label>
<input type="radio" name="pokemon-tabs-ceruledge-937-group" id="pokemon-tabs-ceruledge-937-tab-1">
<label for="pokemon-tabs-ceruledge-937-tab-1">Armarouge</label>
<input type="radio" name="pokemon-tabs-ceruledge-937-group" id="pokemon-tabs-ceruledge-937-tab-2" checked>
<label for="pokemon-tabs-ceruledge-937-tab-2">Ceruledge</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-ceruledge-937-panel-0">
## Charcadet (#935)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-ceruledge-937-panel-1">
## Armarouge (#936)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-ceruledge-937-panel-2">
## Ceruledge (#937)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-ceruledge-937-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-ceruledge-937-panel-0 { display: block; }
#pokemon-tabs-ceruledge-937-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-ceruledge-937-panel-1 { display: block; }
#pokemon-tabs-ceruledge-937-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-ceruledge-937-panel-2 { display: block; }
</style>

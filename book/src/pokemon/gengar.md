...
<summary>Gengar (#157)</summary>
<div class="pokemon-tabs" id="pokemon-tabs-gengar">
<input type="radio" name="pokemon-tabs-gengar-group" id="pokemon-tabs-gengar-tab-0">
<label for="pokemon-tabs-gengar-tab-0">Gastly</label>
<input type="radio" name="pokemon-tabs-gengar-group" id="pokemon-tabs-gengar-tab-1">
<label for="pokemon-tabs-gengar-tab-1">Haunter</label>
<input type="radio" name="pokemon-tabs-gengar-group" id="pokemon-tabs-gengar-tab-2" checked>
<label for="pokemon-tabs-gengar-tab-2">Gengar</label>
<input type="radio" name="pokemon-tabs-gengar-group" id="pokemon-tabs-gengar-tab-3">
<label for="pokemon-tabs-gengar-tab-3">Mega Gengar</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-gengar-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gengar-panel-1">
Types: Ghost / Poison • Egg Groups: Amorphous
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gengar-panel-2">
Types: Ghost / Poison • Egg Groups: Amorphous
...
<div class="pokemon-tab-panel" id="pokemon-tabs-gengar-panel-3">
Types: Ghost / Poison • Egg Groups: Amorphous
...
<style>
#pokemon-tabs-gengar-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-gengar-panel-0 { display: block; }
#pokemon-tabs-gengar-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-gengar-panel-1 { display: block; }
#pokemon-tabs-gengar-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-gengar-panel-2 { display: block; }
#pokemon-tabs-gengar-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-gengar-panel-3 { display: block; }
</style>
</details>

...
<input type="radio" name="pokemon-tabs-obstagoon-group" id="pokemon-tabs-obstagoon-tab-1">
<label for="pokemon-tabs-obstagoon-tab-1">Galarian Linoone</label>
<input type="radio" name="pokemon-tabs-obstagoon-group" id="pokemon-tabs-obstagoon-tab-2" checked>
...
<style>
#pokemon-tabs-obstagoon-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-obstagoon-panel-0 { display: block; }

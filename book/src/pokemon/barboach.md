<div class="pokemon-tabs" id="pokemon-tabs-barboach-339">
<input type="radio" name="pokemon-tabs-barboach-339-group" id="pokemon-tabs-barboach-339-tab-0" checked>
<label for="pokemon-tabs-barboach-339-tab-0">Barboach</label>
<input type="radio" name="pokemon-tabs-barboach-339-group" id="pokemon-tabs-barboach-339-tab-1">
<label for="pokemon-tabs-barboach-339-tab-1">Whiscash</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-barboach-339-panel-0">
## Barboach (#339)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-barboach-339-panel-1">
## Whiscash (#340)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-barboach-339-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-barboach-339-panel-0 { display: block; }
#pokemon-tabs-barboach-339-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-barboach-339-panel-1 { display: block; }
</style>

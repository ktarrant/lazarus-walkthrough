<div class="pokemon-tabs" id="pokemon-tabs-weepinbell-70">
<input type="radio" name="pokemon-tabs-weepinbell-70-group" id="pokemon-tabs-weepinbell-70-tab-0">
<label for="pokemon-tabs-weepinbell-70-tab-0">Bellsprout</label>
<input type="radio" name="pokemon-tabs-weepinbell-70-group" id="pokemon-tabs-weepinbell-70-tab-1" checked>
<label for="pokemon-tabs-weepinbell-70-tab-1">Weepinbell</label>
<input type="radio" name="pokemon-tabs-weepinbell-70-group" id="pokemon-tabs-weepinbell-70-tab-2">
<label for="pokemon-tabs-weepinbell-70-tab-2">Victreebel</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-weepinbell-70-panel-0">
## Bellsprout (#069)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-weepinbell-70-panel-1">
## Weepinbell (#070)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-weepinbell-70-panel-2">
## Victreebel (#071)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-weepinbell-70-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-weepinbell-70-panel-0 { display: block; }
#pokemon-tabs-weepinbell-70-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-weepinbell-70-panel-1 { display: block; }
#pokemon-tabs-weepinbell-70-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-weepinbell-70-panel-2 { display: block; }
</style>

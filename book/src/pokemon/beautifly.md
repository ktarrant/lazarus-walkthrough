...
<label for="pokemon-tabs-beautifly-tab-0">Wurmple</label>
<input type="radio" name="pokemon-tabs-beautifly-group" id="pokemon-tabs-beautifly-tab-1">
<label for="pokemon-tabs-beautifly-tab-1">Silcoon</label>
<input type="radio" name="pokemon-tabs-beautifly-group" id="pokemon-tabs-beautifly-tab-2" checked>
<label for="pokemon-tabs-beautifly-tab-2">Beautifly</label>
<input type="radio" name="pokemon-tabs-beautifly-group" id="pokemon-tabs-beautifly-tab-3">
<label for="pokemon-tabs-beautifly-tab-3">Cascoon</label>
<input type="radio" name="pokemon-tabs-beautifly-group" id="pokemon-tabs-beautifly-tab-4">
<label for="pokemon-tabs-beautifly-tab-4">Dustox</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-beautifly-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-beautifly-panel-1">
Types: Bug • Egg Groups: Bug
...
<div class="pokemon-tab-panel" id="pokemon-tabs-beautifly-panel-2">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-beautifly-panel-3">
Types: Bug • Egg Groups: Bug
...
<div class="pokemon-tab-panel" id="pokemon-tabs-beautifly-panel-4">
...
<style>
#pokemon-tabs-beautifly-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-beautifly-panel-0 { display: block; }
#pokemon-tabs-beautifly-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-beautifly-panel-1 { display: block; }
#pokemon-tabs-beautifly-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-beautifly-panel-2 { display: block; }
#pokemon-tabs-beautifly-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-beautifly-panel-3 { display: block; }
#pokemon-tabs-beautifly-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-beautifly-panel-4 { display: block; }
</style>
</details>

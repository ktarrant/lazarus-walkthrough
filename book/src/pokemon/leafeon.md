...
<label for="pokemon-tabs-leafeon-tab-0">Eevee</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-1">
<label for="pokemon-tabs-leafeon-tab-1">Vaporeon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-2">
<label for="pokemon-tabs-leafeon-tab-2">Jolteon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-3">
<label for="pokemon-tabs-leafeon-tab-3">Flareon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-4">
<label for="pokemon-tabs-leafeon-tab-4">Espeon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-5">
<label for="pokemon-tabs-leafeon-tab-5">Umbreon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-6" checked>
<label for="pokemon-tabs-leafeon-tab-6">Leafeon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-7">
<label for="pokemon-tabs-leafeon-tab-7">Glaceon</label>
<input type="radio" name="pokemon-tabs-leafeon-group" id="pokemon-tabs-leafeon-tab-8">
<label for="pokemon-tabs-leafeon-tab-8">Sylveon</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-0">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-1">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-2">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-3">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-4">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-5">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-6">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-7">
...
<div class="pokemon-tab-panel" id="pokemon-tabs-leafeon-panel-8">
...
<style>
#pokemon-tabs-leafeon-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-0 { display: block; }
#pokemon-tabs-leafeon-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-1 { display: block; }
#pokemon-tabs-leafeon-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-2 { display: block; }
#pokemon-tabs-leafeon-tab-3:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-3 { display: block; }
#pokemon-tabs-leafeon-tab-4:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-4 { display: block; }
#pokemon-tabs-leafeon-tab-5:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-5 { display: block; }
#pokemon-tabs-leafeon-tab-6:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-6 { display: block; }
#pokemon-tabs-leafeon-tab-7:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-7 { display: block; }
#pokemon-tabs-leafeon-tab-8:checked ~ .pokemon-tab-panels #pokemon-tabs-leafeon-panel-8 { display: block; }
</style>
</details>

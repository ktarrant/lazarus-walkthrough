...
<input type="radio" name="pokemon-tabs-mega-scrafty-group" id="pokemon-tabs-mega-scrafty-tab-1">
<label for="pokemon-tabs-mega-scrafty-tab-1">Scrafty</label>
<input type="radio" name="pokemon-tabs-mega-scrafty-group" id="pokemon-tabs-mega-scrafty-tab-2" checked>
...
<style>
#pokemon-tabs-mega-scrafty-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-mega-scrafty-panel-0 { display: block; }

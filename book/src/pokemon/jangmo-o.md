...
<input type="radio" name="pokemon-tabs-jangmo-o-group" id="pokemon-tabs-jangmo-o-tab-1">
<label for="pokemon-tabs-jangmo-o-tab-1">Hakamo-o</label>
<input type="radio" name="pokemon-tabs-jangmo-o-group" id="pokemon-tabs-jangmo-o-tab-2">
...
<style>
#pokemon-tabs-jangmo-o-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-jangmo-o-panel-0 { display: block; }

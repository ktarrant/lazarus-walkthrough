<div class="pokemon-tabs" id="pokemon-tabs-florges-671">
<input type="radio" name="pokemon-tabs-florges-671-group" id="pokemon-tabs-florges-671-tab-0">
<label for="pokemon-tabs-florges-671-tab-0">Flabebe</label>
<input type="radio" name="pokemon-tabs-florges-671-group" id="pokemon-tabs-florges-671-tab-1">
<label for="pokemon-tabs-florges-671-tab-1">Floette</label>
<input type="radio" name="pokemon-tabs-florges-671-group" id="pokemon-tabs-florges-671-tab-2" checked>
<label for="pokemon-tabs-florges-671-tab-2">Florges</label>
<div class="pokemon-tab-panels">
<div class="pokemon-tab-panel" id="pokemon-tabs-florges-671-panel-0">
## Flabebe (#669)
...
<div class="pokemon-tab-panel" id="pokemon-tabs-florges-671-panel-1">
## Floette (#670)
<details class="pokemon-card-container" open>
...
<div class="pokemon-tab-panel" id="pokemon-tabs-florges-671-panel-2">
## Florges (#671)
<details class="pokemon-card-container" open>
...
<style>
#pokemon-tabs-florges-671-tab-0:checked ~ .pokemon-tab-panels #pokemon-tabs-florges-671-panel-0 { display: block; }
#pokemon-tabs-florges-671-tab-1:checked ~ .pokemon-tab-panels #pokemon-tabs-florges-671-panel-1 { display: block; }
#pokemon-tabs-florges-671-tab-2:checked ~ .pokemon-tab-panels #pokemon-tabs-florges-671-panel-2 { display: block; }
</style>

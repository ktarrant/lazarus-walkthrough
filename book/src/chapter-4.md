...
The Level Ball can get up to a very high multiplier, but is less useful because
lower level Pokemon are already easier to catch.
The Quick Ball offers a 4x catchrate on the first turn. Only use on first turn.
The Timer Ball offers a 4x catchrate after 10 turns.
The Lure Ball offers a 4x catchrate when fishing.
The Repeat Ball offers a 3x catchrate on Pokemon caught before,
